...
function insertElementData(element, datum) {
  element.datum(datum);
  element.data([datum], function(d2) {
    return d2.key;
  });
}
function insertAllElementsData(element, datum) {
  ...
  var children = selectAll_default(element.node().childNodes);
  children.each(function(d2, i2) {
    insertAllElementsData(select_default(this), datum.children[i2]);
  });
}
function insertChildren(element, index) {
  ...
  children = children.data(function(d2) {
    return d2.children;
  }, function(d2) {
    return d2.tag + "-" + index;
  });
  var childrenEnter = children.enter().append(function(d2) {
...
function createZoomBehavior() {
  ...
  function zoomed(event) {
    var g3 = select_default(svg.node().querySelector("g"));
...
function getEdgeTitle(datum) {
  return getEdgeGroup(datum).children.find(function(e2) {
    return e2.tag == "title";
  });
}
...
function _render(callback) {
  ...
  function attributeElement2(data2) {
    ...
    if (transitionInstance) {
      ...
      elementTransition.filter(function(d2) {
        ...
        select_default(this).attr("style", d2 && d2.attributes && d2.attributes.style || null);
      });
    }
  ...
  var data = this._data;
  var svg = root.selectAll("svg").data([data], function(d2) {
    return d2.key;
  });
...
// node_modules/d3-graphviz/node_modules/@hpcc-js/wasm/dist/graphviz.js
var r = ArrayBuffer;
var e = Uint8Array;
var t = Uint16Array;
var n = Int16Array;
...
var i = function(r2, t2, n2) {
  if (e.prototype.slice) return e.prototype.slice.call(r2, t2, n2);
  (null == t2 || t2 < 0) && (t2 = 0), (null == n2 || n2 > r2.length) && (n2 = r2.length);
  var o2 = new e(n2 - t2);
  return o2.set(r2.subarray(t2, n2)), o2;
};
var a = function(r2, t2, n2, o2) {
  if (e.prototype.fill) return e.prototype.fill.call(r2, t2, n2, o2);
  for ((null == n2 || n2 < 0) && (n2 = 0), (null == o2 || o2 > r2.length) && (o2 = r2.length); n2 < o2; ++n2) r2[n2] = t2;
  return r2;
};
var u = function(r2, t2, n2, o2) {
  if (e.prototype.copyWithin) return e.prototype.copyWithin.call(r2, t2, n2, o2);
  for ((null == n2 || n2 < 0) && (n2 = 0), (null == o2 || o2 > r2.length) && (o2 = r2.length); n2 < o2; ) r2[t2++] = r2[n2++];
};
...
var c = function(r2, e2, t2) {
  ...
  if (n2.code = r2, Error.captureStackTrace && Error.captureStackTrace(n2, c), !t2) throw n2;
  return n2;
};
var f = function(r2, e2, t2) {
  for (var n2 = 0, o2 = 0; n2 < t2; ++n2) o2 |= r2[e2++] << (n2 << 3);
  return o2;
};
var l = function(r2, t2) {
  ...
  if (25481893 == (a2 >> 4 | r2[3] << 20)) return 8 + (((n2 = r2)[i2 = 4] | n2[i2 + 1] << 8 | n2[i2 + 2] << 16 | n2[i2 + 3] << 24) >>> 0);
  c(0);
};
var h = function(r2) {
...
var d = function(o2, i2, a2) {
  ...
  for (var f2 = 1 << s2, l2 = f2, d2 = -1, w2 = -1, m2 = -1, p2 = f2, v2 = new r(512 + (f2 << 2)), E2 = new n(v2, 0, 256), y2 = new t(v2, 0, 256), B2 = new t(v2, 512, f2), D2 = 512 + (f2 << 1), g2 = new e(v2, D2, f2), L2 = new e(v2, D2 + f2); d2 < 255 && l2 > 0; ) {
    var M2 = h(l2 + 1), G2 = u2 >> 3, X2 = (1 << M2 + 1) - 1, I2 = (o2[G2] | o2[G2 + 1] << 8 | o2[G2 + 2] << 16) >> (7 & u2) & X2, b2 = (1 << M2) - 1, K2 = X2 - l2 - 1, F2 = I2 & b2;
    if (F2 < K2 ? (u2 += M2, I2 = F2) : (u2 += M2 + 1, I2 > b2 && (I2 -= K2)), E2[++d2] = --I2, -1 == I2 ? (l2 += I2, g2[--p2] = d2) : l2 -= I2, !I2) do {
      var x2 = u2 >> 3;
...
var v = function(r2, e2) {
  for (var t2 = r2.length, n2 = new o(t2), i2 = 0; i2 < t2; ++i2) n2[i2] = e2, e2 += 1 << r2[i2];
  return n2;
};
...
var M = function(r2, n2, o2) {
  ...
  if (!(M2 > r2.length)) {
    if (0 == l2) return n2.b = M2, o2 ? (o2.set(r2.subarray(s2, M2), n2.y), n2.y += v2, o2) : i(r2, s2, M2);
    if (2 == l2) {
      var G2 = r2[s2], X2 = 3 & G2, I2 = G2 >> 2 & 3, b2 = G2 >> 4, K2 = 0, F2 = 0;
      X2 < 2 ? 1 & I2 ? b2 |= r2[++s2] << 4 | (2 & I2 && r2[++s2] << 12) : b2 = G2 >> 3 : (F2 = I2, I2 < 2 ? (b2 |= (63 & r2[++s2]) << 4, K2 = r2[s2] >> 6 | r2[++s2] << 2) : 2 == I2 ? (b2 |= r2[++s2] << 4 | (3 & r2[++s2]) << 12, K2 = r2[s2] >> 2 | r2[++s2] << 6) : (b2 |= r2[++s2] << 4 | (63 & r2[++s2]) << 12, K2 = r2[s2] >> 6 | r2[++s2] << 2 | r2[++s2] << 10)), ++s2;
      var x2 = o2 ? o2.subarray(n2.y, n2.y + n2.m) : new e(n2.m), C = x2.length - b2;
      if (0 == X2) x2.set(r2.subarray(s2, s2 += b2), C);
      else if (1 == X2) a(x2, r2[s2++], C);
      else {
        var O = n2.h;
        if (2 == X2) {
          var _ = function(r3, n3) {
            ...
            if (s3 < 128) {
              ...
              for (var B2 = 0, D2 = 0, g2 = v3.b, L2 = g2, M3 = (++n3 << 3) - 8 + h(y2); !((M3 -= g2) < E2); ) {
                var G3 = M3 >> 3;
                if (B2 += (r3[G3] | r3[G3 + 1] << 8) >> (7 & M3) & (1 << g2) - 1, f3[++i2] = v3.s[B2], (M3 -= L2) < E2) break;
              ...
              for (i2 = s3 - 127; o3 < i2; o3 += 2) {
                var X3 = r3[++n3];
                f3[o3] = X3 >> 4, f3[o3 + 1] = 15 & X3;
              }
              ++n3;
            }
            var I3 = 0;
            for (o3 = 0; o3 < i2; ++o3) (x3 = f3[o3]) > 11 && c(0), I3 += x3 && 1 << x3 - 1;
      ...
      if (H) {
        ...
        var P = r2[s2++];
        3 & P && c(0);
        for (var N = [m, p, w], Y = 2; Y > -1; --Y) {
          var z = P >> 2 + (Y << 1) & 3;
          if (1 == z) {
            var W = new e([0, 0, r2[s2++]]);
            N[Y] = { s: W.subarray(2, 3), n: W.subarray(0, 1), t: new t(W.buffer, 0, 1), b: 0 };
          } else 2 == z ? (s2 = (u2 = d(r2, s2, 9 - (1 & Y)))[0], N[Y] = u2[1]) : 3 == z && (n2.t || c(0), N[Y] = n2.t[Y]);
        }
        ...
        for (++H; --H; ) {
          ...
          if (q = (j -= A) >> 3, J = V.t[J] + ((r2[q] | r2[q + 1] << 8) >> (7 & j) & (1 << A) - 1), q = (j -= er) >> 3, S = R.t[S] + ((r2[q] | r2[q + 1] << 8) >> (7 & j) & (1 << er) - 1), q = (j -= nr) >> 3, Z = k.t[Z] + ((r2[q] | r2[q + 1] << 8) >> (7 & j) & (1 << nr) - 1), ir > 3) n2.o[2] = n2.o[1], n2.o[1] = n2.o[0], n2.o[0] = ir -= 3;
          else {
            var sr = ir - (0 != ur);
            sr ? (ir = 3 == sr ? n2.o[0] - 1 : n2.o[sr], sr > 1 && (n2.o[2] = n2.o[1]), n2.o[1] = n2.o[0], n2.o[0] = ir) : ir = n2.o[0];
          }
          for (Y = 0; Y < ur; ++Y) x2[T + Y] = x2[C + Y];
          C += ur;
          var cr = (T += ur) - ir;
          if (cr < 0) {
            var fr = -cr, lr = n2.e + cr;
            fr > ar && (fr = ar);
            for (Y = 0; Y < fr; ++Y) x2[T + Y] = n2.w[lr + Y];
            T += fr, ar -= fr, cr = 0;
          }
          for (Y = 0; Y < ar; ++Y) x2[T + Y] = x2[cr + Y];
          T += ar;
        }
        if (T != C) for (; C < x2.length; ) x2[T++] = x2[C++];
        else T = x2.length;
        o2 ? n2.y += T : x2 = i(x2, 0, T);
      } else if (o2) {
        if (n2.y += b2, C) for (Y = 0; Y < b2; ++Y) x2[Y] = x2[C + Y];
      } else C && (x2 = i(x2, C));
      return n2.b = M2, x2;
    }
    c(2);
...
var I = ("undefined" != typeof document && document.currentScript && document.currentScript.src, function(r2) {
  ...
  function g2(r3, e3, t3) {
    for (var n3 = e3 + t3, o3 = e3; r3[o3] && !(o3 >= n3); ) ++o3;
    if (o3 - e3 > 16 && r3.buffer && D2) return D2.decode(r3.subarray(e3, o3));
    for (var i3 = ""; e3 < o3; ) {
      var a3 = r3[e3++];
      if (128 & a3) {
        var u3 = 63 & r3[e3++];
        if (192 != (224 & a3)) {
          var s3 = 63 & r3[e3++];
          if ((a3 = 224 == (240 & a3) ? (15 & a3) << 12 | u3 << 6 | s3 : (7 & a3) << 18 | u3 << 12 | s3 << 6 | 63 & r3[e3++]) < 65536) i3 += String.fromCharCode(a3);
          else {
            var c3 = a3 - 65536;
            i3 += String.fromCharCode(55296 | c3 >> 10, 56320 | 1023 & c3);
          }
        } else i3 += String.fromCharCode((31 & a3) << 6 | u3);
  ...
  function Q(r3) {
    try {
      if (r3 == I2 && o2) return new Uint8Array(o2);
  ...
  function U(r3) {
    this.excPtr = r3, this.ptr = r3 - 24, this.set_type = function(r4) {
      ...
      if (Xr(this.get_type())) return y2[this.excPtr >> 2];
  ...
  var j = { isAbs: (r3) => "/" === r3.charAt(0), splitPath: (r3) => /^(\/?|)([\s\S]*?)((?:\.{1,2}|[^\/]+?|)(\.[^.\/]*|))(?:[\/]*)$/.exec(r3).slice(1), normalizeArray: (r3, e3) => {
    ...
    for (var n3 = t3(r3.split("/")), o3 = t3(e3.split("/")), i3 = Math.min(n3.length, o3.length), a3 = i3, u3 = 0; u3 < i3; u3++) if (n3[u3] !== o3[u3]) {
      a3 = u3;
      break;
    }
    var s3 = [];
    for (u3 = a3; u3 < n3.length; u3++) s3.push("..");
  ...
  var J = { ttys: [], init: function() {
    ...
    if (!r3.tty || !r3.tty.ops.get_char) throw new $.ErrnoError(60);
    for (var i3 = 0, a3 = 0; a3 < n3; a3++) {
      ...
      if (void 0 === u3 && 0 === i3) throw new $.ErrnoError(6);
      if (null == u3) break;
      i3++, e3[t3 + a3] = u3;
    }
    return i3 && (r3.node.timestamp = Date.now()), i3;
  }, write: function(r3, e3, t3, n3, o3) {
    if (!r3.tty || !r3.tty.ops.put_char) throw new $.ErrnoError(60);
    try {
      for (var i3 = 0; i3 < n3; i3++) r3.tty.ops.put_char(r3.tty, e3[t3 + i3]);
    } catch (r4) {
      throw new $.ErrnoError(29);
    }
  ...
  var S = { ops_table: null, mount: function(r3) {
    ...
    if ($.isBlkdev(t3) || $.isFIFO(t3)) throw new $.ErrnoError(63);
    ...
    if ($.isDir(r3.mode)) {
      ...
      if (n3) for (var o3 in n3.contents) throw new $.ErrnoError(55);
    }
    ...
    for (var n3 in t3.contents) throw new $.ErrnoError(55);
    delete r3.contents[e3], r3.timestamp = Date.now();
  }, readdir: function(r3) {
    var e3 = [".", ".."];
    for (var t3 in r3.contents) r3.contents.hasOwnProperty(t3) && e3.push(t3);
    return e3;
  }, symlink: function(r3, e3, t3) {
    var n3 = S.createNode(r3, e3, 41471, 0);
    return n3.link = t3, n3;
  }, readlink: function(r3) {
    if (!$.isLink(r3.mode)) throw new $.ErrnoError(28);
    return r3.link;
    ...
    if (a3 > 8 && i3.subarray) e3.set(i3.subarray(o3, o3 + a3), t3);
    else for (var u3 = 0; u3 < a3; u3++) e3[t3 + u3] = i3[o3 + u3];
    return a3;
  }, write: function(r3, e3, t3, n3, o3, i3) {
    if (e3.buffer === m2.buffer && (i3 = false), !n3) return 0;
    var a3 = r3.node;
    if (a3.timestamp = Date.now(), e3.subarray && (!a3.contents || a3.contents.subarray)) {
      if (i3) return a3.contents = e3.subarray(t3, t3 + n3), a3.usedBytes = n3, n3;
      if (0 === a3.usedBytes && 0 === o3) return a3.contents = e3.slice(t3, t3 + n3), a3.usedBytes = n3, n3;
      if (o3 + n3 <= a3.usedBytes) return a3.contents.set(e3.subarray(t3, t3 + n3), o3), n3;
    }
    if (S.expandFileStorage(a3, o3 + n3), a3.contents.subarray && e3.subarray) a3.contents.set(e3.subarray(t3, t3 + n3), o3);
    else for (var u3 = 0; u3 < n3; u3++) a3.contents[o3 + u3] = e3[t3 + u3];
    return a3.usedBytes = Math.max(a3.usedBytes, o3 + n3), n3;
  }, llseek: function(r3, e3, t3) {
    var n3 = e3;
    if (1 === t3 ? n3 += r3.position : 2 === t3 && $.isFile(r3.node.mode) && (n3 += r3.node.usedBytes), n3 < 0) throw new $.ErrnoError(28);
    return n3;
    ...
    if (!$.isFile(r3.node.mode)) throw new $.ErrnoError(43);
    var i3, a3, u3 = r3.node.contents;
    if (2 & o3 || u3.buffer !== w2) {
      if ((t3 > 0 || t3 + e3 < u3.length) && (u3 = u3.subarray ? u3.subarray(t3, t3 + e3) : Array.prototype.slice.call(u3, t3, t3 + e3)), a3 = true, !(i3 = Z(e3))) throw new $.ErrnoError(48);
      m2.set(u3, i3);
    } else a3 = false, i3 = u3.byteOffset;
    ...
    if ((e3 = Object.assign({ follow_mount: true, recurse_count: 0 }, e3)).recurse_count > 8) throw new $.ErrnoError(32);
    for (var t3 = r3.split("/").filter((r4) => !!r4), n3 = $.root, o3 = "/", i3 = 0; i3 < t3.length; i3++) {
      var a3 = i3 === t3.length - 1;
      if (a3 && e3.parent) break;
      if (n3 = $.lookupNode(n3, t3[i3]), o3 = j.join2(o3, t3[i3]), $.isMountpoint(n3) && (!a3 || a3 && e3.follow_mount) && (n3 = n3.mounted.root), !a3 || e3.follow) for (var u3 = 0; $.isLink(n3.mode); ) {
        var s3 = $.readlink(o3);
        if (o3 = q.resolve(j.dirname(o3), s3), n3 = $.lookupPath(o3, { recurse_count: e3.recurse_count + 1 }).node, u3++ > 40) throw new $.ErrnoError(32);
      }
    }
    ...
    var e3 = $.hashName(r3.parent.id, r3.name);
    if ($.nameTable[e3] === r3) $.nameTable[e3] = r3.name_next;
    else for (var t3 = $.nameTable[e3]; t3; ) {
      if (t3.name_next === r3) {
    ...
    var t3 = $.mayLookup(r3);
    if (t3) throw new $.ErrnoError(t3, r3);
    for (var n3 = $.hashName(r3.id, e3), o3 = $.nameTable[n3]; o3; o3 = o3.name_next) {
      var i3 = o3.name;
      if (o3.parent.id === r3.id && i3 === e3) return o3;
    }
    return $.lookup(r3, e3);
    ...
    if (o3) return o3;
    if (t3) {
      if (!$.isDir(n3.mode)) return 54;
      if ($.isRoot(n3) || $.getPath(n3) === $.cwd()) return 10;
    } else if ($.isDir(n3.mode)) return 31;
    return 0;
    ...
    for (var t3 = r3; t3 <= e3; t3++) if (!$.streams[t3]) return t3;
    ...
    function i3(r4) {
      if (r4) return i3.errored ? void 0 : (i3.errored = true, o3(r4));
      ++n3 >= t3.length && o3(null);
    }
    t3.forEach((e4) => {
      if (!e4.type.syncfs) return i3(null);
      e4.type.syncfs(e4, r3, i3);
    });
  }, mount: (r3, e3, t3) => {
    var n3, o3 = "/" === t3, i3 = !t3;
    if (o3 && $.root) throw new $.ErrnoError(10);
    if (!o3 && !i3) {
      var a3 = $.lookupPath(t3, { follow_mount: false });
      if (t3 = a3.path, n3 = a3.node, $.isMountpoint(n3)) throw new $.ErrnoError(10);
      if (!$.isDir(n3.mode)) throw new $.ErrnoError(54);
    }
    ...
    if (!$.isMountpoint(e3.node)) throw new $.ErrnoError(28);
    ...
    if (!o3 || "." === o3 || ".." === o3) throw new $.ErrnoError(28);
    var i3 = $.mayCreate(n3, o3);
    if (i3) throw new $.ErrnoError(i3);
    if (!n3.node_ops.mknod) throw new $.ErrnoError(63);
    ...
    for (var t3 = r3.split("/"), n3 = "", o3 = 0; o3 < t3.length; ++o3) if (t3[o3]) {
      n3 += "/" + t3[o3];
      try {
        $.mkdir(n3, e3);
      } catch (r4) {
    ...
    if (!q.resolve(r3)) throw new $.ErrnoError(44);
    var t3 = $.lookupPath(e3, { parent: true }).node;
    if (!t3) throw new $.ErrnoError(44);
    var n3 = j.basename(e3), o3 = $.mayCreate(t3, n3);
    if (o3) throw new $.ErrnoError(o3);
    if (!t3.node_ops.symlink) throw new $.ErrnoError(63);
    return t3.node_ops.symlink(t3, n3, r3);
  }, rename: (r3, e3) => {
    var t3, n3, o3 = j.dirname(r3), i3 = j.dirname(e3), a3 = j.basename(r3), u3 = j.basename(e3);
    if (t3 = $.lookupPath(r3, { parent: true }).node, n3 = $.lookupPath(e3, { parent: true }).node, !t3 || !n3) throw new $.ErrnoError(44);
    if (t3.mount !== n3.mount) throw new $.ErrnoError(75);
    var s3, c3 = $.lookupNode(t3, a3), f3 = q.relative(r3, i3);
    if ("." !== f3.charAt(0)) throw new $.ErrnoError(28);
    if ("." !== (f3 = q.relative(e3, o3)).charAt(0)) throw new $.ErrnoError(55);
    try {
      s3 = $.lookupNode(n3, u3);
    } catch (r4) {
    }
    if (c3 !== s3) {
      ...
      if (h3) throw new $.ErrnoError(h3);
      if (h3 = s3 ? $.mayDelete(n3, u3, l3) : $.mayCreate(n3, u3)) throw new $.ErrnoError(h3);
      if (!t3.node_ops.rename) throw new $.ErrnoError(63);
      if ($.isMountpoint(c3) || s3 && $.isMountpoint(s3)) throw new $.ErrnoError(10);
      if (n3 !== t3 && (h3 = $.nodePermissions(t3, "w"))) throw new $.ErrnoError(h3);
      $.hashRemoveNode(c3);
      try {
    ...
    if (o3) throw new $.ErrnoError(o3);
    if (!e3.node_ops.rmdir) throw new $.ErrnoError(63);
    if ($.isMountpoint(n3)) throw new $.ErrnoError(10);
    e3.node_ops.rmdir(e3, t3), $.destroyNode(n3);
  }, readdir: (r3) => {
    var e3 = $.lookupPath(r3, { follow: true }).node;
    if (!e3.node_ops.readdir) throw new $.ErrnoError(54);
    return e3.node_ops.readdir(e3);
  }, unlink: (r3) => {
    var e3 = $.lookupPath(r3, { parent: true }).node;
    if (!e3) throw new $.ErrnoError(44);
    var t3 = j.basename(r3), n3 = $.lookupNode(e3, t3), o3 = $.mayDelete(e3, t3, false);
    if (o3) throw new $.ErrnoError(o3);
    if (!e3.node_ops.unlink) throw new $.ErrnoError(63);
    if ($.isMountpoint(n3)) throw new $.ErrnoError(10);
    e3.node_ops.unlink(e3, t3), $.destroyNode(n3);
  }, readlink: (r3) => {
    var e3 = $.lookupPath(r3).node;
    if (!e3) throw new $.ErrnoError(44);
    if (!e3.node_ops.readlink) throw new $.ErrnoError(28);
    return q.resolve($.getPath(e3.parent), e3.node_ops.readlink(e3));
  }, stat: (r3, e3) => {
    var t3 = $.lookupPath(r3, { follow: !e3 }).node;
    if (!t3) throw new $.ErrnoError(44);
    if (!t3.node_ops.getattr) throw new $.ErrnoError(63);
    return t3.node_ops.getattr(t3);
  }, lstat: (r3) => $.stat(r3, true), chmod: (r3, e3, t3) => {
    var n3;
    if (!(n3 = "string" == typeof r3 ? $.lookupPath(r3, { follow: !t3 }).node : r3).node_ops.setattr) throw new $.ErrnoError(63);
    n3.node_ops.setattr(n3, { mode: 4095 & e3 | -4096 & n3.mode, timestamp: Date.now() });
  }, lchmod: (r3, e3) => {
    $.chmod(r3, e3, true);
  }, fchmod: (r3, e3) => {
    var t3 = $.getStream(r3);
    if (!t3) throw new $.ErrnoError(8);
    $.chmod(t3.node, e3);
  }, chown: (r3, e3, t3, n3) => {
    var o3;
    if (!(o3 = "string" == typeof r3 ? $.lookupPath(r3, { follow: !n3 }).node : r3).node_ops.setattr) throw new $.ErrnoError(63);
    o3.node_ops.setattr(o3, { timestamp: Date.now() });
  }, lchown: (r3, e3, t3) => {
    $.chown(r3, e3, t3, true);
  }, fchown: (r3, e3, t3) => {
    var n3 = $.getStream(r3);
    if (!n3) throw new $.ErrnoError(8);
    $.chown(n3.node, e3, t3);
  }, truncate: (r3, e3) => {
    if (e3 < 0) throw new $.ErrnoError(28);
    var t3;
    if (!(t3 = "string" == typeof r3 ? $.lookupPath(r3, { follow: true }).node : r3).node_ops.setattr) throw new $.ErrnoError(63);
    if ($.isDir(t3.mode)) throw new $.ErrnoError(31);
    if (!$.isFile(t3.mode)) throw new $.ErrnoError(28);
    var n3 = $.nodePermissions(t3, "w");
    if (n3) throw new $.ErrnoError(n3);
    t3.node_ops.setattr(t3, { size: e3, timestamp: Date.now() });
  }, ftruncate: (r3, e3) => {
    var t3 = $.getStream(r3);
    if (!t3) throw new $.ErrnoError(8);
    if (0 == (2097155 & t3.flags)) throw new $.ErrnoError(28);
    $.truncate(t3.node, e3);
  }, utime: (r3, e3, t3) => {
    var n3 = $.lookupPath(r3, { follow: true }).node;
    n3.node_ops.setattr(n3, { timestamp: Math.max(e3, t3) });
  }, open: (r3, e3, t3) => {
    if ("" === r3) throw new $.ErrnoError(44);
    var o3;
    if (t3 = void 0 === t3 ? 438 : t3, t3 = 64 & (e3 = "string" == typeof e3 ? $.modeStringToFlags(e3) : e3) ? 4095 & t3 | 32768 : 0, "object" == typeof r3) o3 = r3;
    else {
      r3 = j.normalize(r3);
      try {
    ...
    var i3 = false;
    if (64 & e3) if (o3) {
      if (128 & e3) throw new $.ErrnoError(20);
    } else o3 = $.mknod(r3, t3, 0), i3 = true;
    if (!o3) throw new $.ErrnoError(44);
    if ($.isChrdev(o3.mode) && (e3 &= -513), 65536 & e3 && !$.isDir(o3.mode)) throw new $.ErrnoError(54);
    if (!i3) {
      var a3 = $.mayOpen(o3, e3);
      if (a3) throw new $.ErrnoError(a3);
    }
    ...
    if ($.isClosed(r3)) throw new $.ErrnoError(8);
    ...
    if ($.isClosed(r3)) throw new $.ErrnoError(8);
    if (!r3.seekable || !r3.stream_ops.llseek) throw new $.ErrnoError(70);
    if (0 != t3 && 1 != t3 && 2 != t3) throw new $.ErrnoError(28);
    return r3.position = r3.stream_ops.llseek(r3, e3, t3), r3.ungotten = [], r3.position;
  }, read: (r3, e3, t3, n3, o3) => {
    if (n3 < 0 || o3 < 0) throw new $.ErrnoError(28);
    if ($.isClosed(r3)) throw new $.ErrnoError(8);
    if (1 == (2097155 & r3.flags)) throw new $.ErrnoError(8);
    if ($.isDir(r3.node.mode)) throw new $.ErrnoError(31);
    if (!r3.stream_ops.read) throw new $.ErrnoError(28);
    var i3 = void 0 !== o3;
    if (i3) {
      if (!r3.seekable) throw new $.ErrnoError(70);
    } else o3 = r3.position;
    ...
    if (n3 < 0 || o3 < 0) throw new $.ErrnoError(28);
    if ($.isClosed(r3)) throw new $.ErrnoError(8);
    if (0 == (2097155 & r3.flags)) throw new $.ErrnoError(8);
    if ($.isDir(r3.node.mode)) throw new $.ErrnoError(31);
    if (!r3.stream_ops.write) throw new $.ErrnoError(28);
    ...
    if ($.isClosed(r3)) throw new $.ErrnoError(8);
    if (e3 < 0 || t3 <= 0) throw new $.ErrnoError(28);
    if (0 == (2097155 & r3.flags)) throw new $.ErrnoError(8);
    if (!$.isFile(r3.node.mode) && !$.isDir(r3.node.mode)) throw new $.ErrnoError(43);
    if (!r3.stream_ops.allocate) throw new $.ErrnoError(138);
    r3.stream_ops.allocate(r3, e3, t3);
  }, mmap: (r3, e3, t3, n3, o3) => {
    if (0 != (2 & n3) && 0 == (2 & o3) && 2 != (2097155 & r3.flags)) throw new $.ErrnoError(2);
    if (1 == (2097155 & r3.flags)) throw new $.ErrnoError(2);
    if (!r3.stream_ops.mmap) throw new $.ErrnoError(43);
    ...
    if (!r3.stream_ops.ioctl) throw new $.ErrnoError(59);
    ...
    if (null === e3.node) throw new $.ErrnoError(44);
    if (!$.isDir(e3.node.mode)) throw new $.ErrnoError(54);
    var t3 = $.nodePermissions(e3.node, "x");
    if (t3) throw new $.ErrnoError(t3);
    $.currentPath = e3.path;
    ...
    if (t3) {
      if ("string" == typeof t3) {
        for (var c3 = new Array(t3.length), f3 = 0, l3 = t3.length; f3 < l3; ++f3) c3[f3] = t3.charCodeAt(f3);
        t3 = c3;
      }
      $.chmod(s3, 146 | u3);
      var h3 = $.open(s3, 577);
    ...
    return $.registerDevice(a3, { open: (r4) => {
      ...
      for (var a4 = 0, u3 = 0; u3 < o4; u3++) {
        ...
        if (void 0 === s3 && 0 === a4) throw new $.ErrnoError(6);
        if (null == s3) break;
        a4++, e4[n4 + u3] = s3;
      }
      return a4 && (r4.node.timestamp = Date.now()), a4;
    }, write: (r4, e4, t4, o4, i4) => {
      for (var a4 = 0; a4 < o4; a4++) try {
        n3(e4[t4 + a4]);
      } catch (r5) {
        throw new $.ErrnoError(29);
      }
    ...
    if (i3.prototype.get = function(r4) {
      ...
      if (r4.open("HEAD", t3, false), r4.send(null), !(r4.status >= 200 && r4.status < 300 || 304 === r4.status)) throw new Error("Couldn't load " + t3 + ". Status: " + r4.status);
      ...
      u4.setDataGetter((r5) => {
        ...
        if (o5 = Math.min(o5, n4 - 1), void 0 === u4.chunks[r5] && (u4.chunks[r5] = ((r6, e6) => {
          if (r6 > e6) throw new Error("invalid range (" + r6 + ", " + e6 + ") or no bytes requested!");
          if (e6 > n4 - 1) throw new Error("only " + n4 + " bytes available! programmer error!");
          var o6 = new XMLHttpRequest();
          if (o6.open("GET", t3, false), n4 !== a4 && o6.setRequestHeader("Range", "bytes=" + r6 + "-" + e6), o6.responseType = "arraybuffer", o6.overrideMimeType && o6.overrideMimeType("text/plain; charset=x-user-defined"), o6.send(null), !(o6.status >= 200 && o6.status < 300 || 304 === o6.status)) throw new Error("Couldn't load " + t3 + ". Status: " + o6.status);
          return void 0 !== o6.response ? new Uint8Array(o6.response || []) : T(o6.responseText || "", true);
        })(e5, o5)), void 0 === u4.chunks[r5]) throw new Error("doXHR failed!");
        return u4.chunks[r5];
    ...
    function f3(r4, e4, t4, n4, o4) {
      ...
      if (o4 >= i4.length) return 0;
      var a4 = Math.min(i4.length - o4, n4);
      if (i4.slice) for (var u4 = 0; u4 < a4; u4++) e4[t4 + u4] = i4[o4 + u4];
      else for (u4 = 0; u4 < a4; u4++) e4[t4 + u4] = i4.get(o4 + u4);
      return a4;
    }
    ...
    P(), "string" == typeof t3 ? function(r4, e4, t4, n4) {
      ...
      (void 0)(r4, (t5) => {
        ...
        if (!t4) throw 'Loading data file "' + r4 + '" failed.';
        t4();
      }), o4 && P();
    ...
    try {
      ...
      if (r4 && r4.node && j.normalize(e3) !== j.normalize($.getPath(r4.node))) return -54;
      throw r4;
    }
    ...
    if (!$.isFile(e3.node.mode)) throw new $.ErrnoError(43);
    if (2 & n3) return 0;
    ...
    var e3 = $.getStream(r3);
    if (!e3) throw new $.ErrnoError(8);
    return e3;
  } }, rr = [];
  function er(r3, e3, t3) {
    var n3 = function(r4, e4) {
      var t4;
      for (rr.length = 0, e4 >>= 2; t4 = p2[r4++]; ) e4 += 105 != t4 & e4, rr.push(105 == t4 ? E2[e4] : B2[e4++ >> 1]), ++e4;
      return rr;
    }(e3, t3);
  ...
  function tr(r3) {
    try {
      return f2.grow(r3 - w2.byteLength + 65535 >>> 16), X2(f2.buffer), 1;
    } catch (r4) {
    }
  }
  var nr = {};
  function or() {
    if (!or.strings) {
      ...
      for (var e3 in nr) void 0 === nr[e3] ? delete r3[e3] : r3[e3] = nr[e3];
      var t3 = [];
  ...
  function fr(r3, e3, t3, n3) {
    ...
    for (var s3 in u3) a3 = a3.replace(new RegExp(s3, "g"), u3[s3]);
    ...
    function p3(r4) {
      var e4 = function(r5, e5) {
        for (var t5 = new Date(r5.getTime()); e5 > 0; ) {
          ...
          if (!(e5 > i5 - t5.getDate())) return t5.setDate(t5.getDate() + e5), t5;
    ...
    for (var s3 in a3 = a3.replace(/%%/g, "\0\0"), v3) a3.includes(s3) && (a3 = a3.replace(new RegExp(s3, "g"), v3[s3](i3)));
  ...
  var wr = { b: function(r3, e3, t3) {
    ...
    try {
      return e3 = A.getStr(e3), e3 = A.calculateAt(r3, e3), 0 === t3 ? $.unlink(e3) : 512 === t3 ? $.rmdir(e3) : Y("Invalid flags passed to unlinkat"), 0;
    } catch (r4) {
      if (void 0 === $ || !(r4 instanceof $.ErrnoError)) throw r4;
      return -r4.errno;
    }
    ...
    for (var i3 = 1; i3 <= 4; i3 *= 2) {
      var a3 = n3 * (1 + 0.2 / i3);
      if (a3 = Math.min(a3, r3 + 100663296), tr(Math.min(o3, (e3 = Math.max(r3, a3)) + ((t3 = 65536) - e3 % t3) % t3))) return true;
    }
    return false;
  }, s: function(r3, e3) {
    var t3 = 0;
    return or().forEach(function(n3, o3) {
      ...
      y2[r3 + 4 * o3 >> 2] = i3, function(r4, e4, t4) {
        for (var n4 = 0; n4 < r4.length; ++n4) m2[e4++ >> 0] = r4.charCodeAt(n4);
        t4 || (m2[e4 >> 0] = 0);
  ...
  !function() {
    ...
    function e3(r4, e4) {
      ...
      n2.asm = o3, X2((f2 = n2.asm.z).buffer), n2.asm.J, t3 = n2.asm.A, C.unshift(t3), N();
    }
    function i3(r4) {
      e3(r4.instance);
    }
    function a3(e4) {
      return Promise.resolve().then(function() {
        ...
        c2("failed to asynchronously prepare wasm: " + r4), Y(r4);
      });
    }
    if (P(), n2.instantiateWasm) try {
  ...
  function Ir(r3) {
    function t3() {
      Lr || (Lr = true, n2.calledRun = true, h2 || (n2.noFSInit || $.init.initialized || $.init(), $.ignorePermissions = false, V(C), e2(n2), n2.onRuntimeInitialized && n2.onRuntimeInitialized(), function() {
        if (n2.postRun) for ("function" == typeof n2.postRun && (n2.postRun = [n2.postRun]); n2.postRun.length; ) r4 = n2.postRun.shift(), O.unshift(r4);
        var r4;
        V(O);
      }()));
    }
    _ > 0 || (function() {
      if (n2.preRun) for ("function" == typeof n2.preRun && (n2.preRun = [n2.preRun]); n2.preRun.length; ) r4 = n2.preRun.shift(), x2.unshift(r4);
      var r4;
      V(x2);
  ...
  var xr = { buffer: 0, size: 0, pos: 0, temps: [], needed: 0, prepare: function() {
    if (xr.needed) {
      for (var r3 = 0; r3 < xr.temps.length; r3++) n2._free(xr.temps[r3]);
    ...
    for (var n3 = 0; n3 < r3.length; n3++) e3[t3 + n3] = r3[n3];
  } };
  function Cr(r3) {
    if ("string" == typeof r3) {
    ...
    if (growEnteringEdges && !prevDatum && datum.parent) {
      if (isEdgeElement(datum)) {
        if (tag == "path" || tag == "polygon") {
          if (tag == "polygon") {
            var path2 = datum.parent.children.find(function(e2) {
              return e2.tag == "path";
            });
            if (path2) {
...
function graphviz(selector, options) {
  var g2 = select_default(selector).graphviz(options);
  return g2;
}
