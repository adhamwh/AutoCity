...
function extractAllElementsData(element) {
  ...
  datum.children = [];
  var children = selectAll_default(element.node().childNodes);
  children.each(function() {
    var childData = extractAllElementsData(select_default(this));
...
function createElementWithAttributes(data) {
  ...
  var element = select_default(elementNode);
...
function replaceElement(element, data) {
  var parent = select_default(element.node().parentNode);
...
function insertAllElementsData(element, datum) {
  ...
  children.each(function(d, i) {
    insertAllElementsData(select_default(this), datum.children[i]);
  });
}
...
function attributeElement(data, index = 0) {
  var element = select_default(this);
  var tag = data.tag;
  var attributes = data.attributes;
...
function createZoomBehavior() {
  ...
  function zoomed(event) {
    var g2 = select_default(svg.node().querySelector("g"));
    g2.attr("transform", event.transform);
    graphvizInstance._dispatch.call("zoom", graphvizInstance);
  }
  var root = this._selection;
  var svg = select_default(root.node().querySelector("svg"));
  if (svg.size() == 0) {
    return this;
  }
  this._zoomSelection = svg;
  var zoomBehavior2 = zoom_default().scaleExtent(this._options.zoomScaleExtent).translateExtent(this._options.zoomTranslateExtent).interpolate(value_default).on("zoom", zoomed);
  this._zoomBehavior = zoomBehavior2;
  var g = select_default(svg.node().querySelector("g"));
...
function translateZoomBehaviorTransform(selection) {
  ...
  this._originalTransform = identity.translate(selection.datum().translation.x, selection.datum().translation.y).scale(selection.datum().scale);
}
function resetZoom(transition2) {
  var selection = this._zoomSelection;
  if (transition2) {
    selection = selection.transition(transition2);
  }
...
function pathTweenPoints(node, d1, precision, precisionIsRelative) {
  ...
  const distances = [0];
  let i = 0;
  const dt2 = precisionIsRelative ? precision : precision / Math.max(n0, n1);
  while ((i += dt2) < 1) {
    distances.push(i);
  }
  distances.push(1);
  ...
  function insertChildren2(element) {
    ...
    if (fade || growEnteringEdges && isEdgeElementParent(element.datum())) {
      var childElementsEnter = childrenEnter.filter(function(d) {
        ...
        var childEnter = select_default(this);
    ...
    children.each(attributeElement2);
  }
  function attributeElement2(data2) {
    ...
    if (transitionInstance) {
      ...
      elementTransition.filter(function(d) {
        ...
        select_default(this).attr("style", d && d.attributes && d.attributes.style || null);
      });
    }
    ...
    if (growThisPath) {
      ...
      elementTransition.attr("stroke-dashoffset", attributes["stroke-dashoffset"]).attr("transform", attributes["transform"]).on("start", function() {
        select_default(this).style("opacity", null);
      }).on("end", function() {
        select_default(this).attr("stroke-dashoffset", null).attr("stroke-dasharray", null).attr("transform", null);
      });
    }
    var moveThisPolygon = growEnteringEdges && tag == "polygon" && isEdgeElement(data2) && data2.offset && data2.parent.children[3].tag == "path";
    if (moveThisPolygon) {
      var edgePath = select_default(element.node().parentNode.querySelector("path"));
      ...
      elementTransition.attrTween("transform", function() {
        ...
        select_default(this).attr("transform", null);
      });
    }
    ...
    if (convertShape) {
      elementTransition.on("end", function(d, i2, nodes) {
        pathElement = select_default(this);
...
var fo = Int16Array;
var $r = Int32Array;
var st = function(c, f, s) {
  if (V.prototype.slice) return V.prototype.slice.call(c, f, s);
  (f == null || f < 0) && (f = 0), (s == null || s > c.length) && (s = c.length);
  var l = new V(s - f);
  return l.set(c.subarray(f, s)), l;
};
var Wr = function(c, f, s, l) {
  if (V.prototype.fill) return V.prototype.fill.call(c, f, s, l);
  for ((s == null || s < 0) && (s = 0), (l == null || l > c.length) && (l = c.length); s < l; ++s) c[s] = f;
  return c;
};
var lo = function(c, f, s, l) {
  if (V.prototype.copyWithin) return V.prototype.copyWithin.call(c, f, s, l);
  for ((s == null || s < 0) && (s = 0), (l == null || l > c.length) && (l = c.length); s < l; ) c[f++] = c[s++];
};
var ho = ["invalid zstd data", "window size too large (>2046MB)", "invalid block type", "FSE accuracy too high", "match distance too far back", "unexpected EOF"];
var J = function(c, f, s) {
  var l = new Error(f || ho[c]);
  if (l.code = c, Error.captureStackTrace && Error.captureStackTrace(l, J), !s) throw l;
  return l;
};
var Pt = function(c, f, s) {
  for (var l = 0, h = 0; l < s; ++l) h |= c[f++] << (l << 3);
  return h;
};
var po = function(c, f) {
...
var wo = function(c, f) {
  var s = c[0] | c[1] << 8 | c[2] << 16;
  if (s == 3126568 && c[3] == 253) {
    var l = c[4], h = l >> 5 & 1, m = l >> 2 & 1, v = l & 3, _ = l >> 6;
    l & 8 && J(0);
    var F = 6 - h, x = v == 3 ? 4 : v, z = Pt(c, F, x);
    F += x;
    var Z = _ ? 1 << _ : h, C = Pt(c, F, Z) + (_ == 1 && 256), W = C;
    if (!h) {
      var Q = 1 << 10 + (c[5] >> 3);
      W = Q + (Q >> 3) * (c[5] & 7);
    }
    W > 2145386496 && J(1);
    var G = new V((f == 1 ? C || W : f ? 0 : W) + 12);
    return G[0] = 1, G[4] = 4, G[8] = 8, { b: F + Z, y: 0, l: 0, d: z, w: f && f != 1 ? f : G.subarray(12), e: W, o: new $r(G.buffer, 0, 3), u: C, c: m, m: Math.min(131072, W) };
  } else if ((s >> 4 | c[3] << 20) == 25481893) return po(c, 4) + 8;
  J(0);
};
var Mr = function(c) {
  for (var f = 0; 1 << f <= c; ++f) ;
...
var qr = function(c, f, s) {
  var l = (f << 3) + 4, h = (c[f] & 15) + 5;
  h > s && J(3);
  for (var m = 1 << h, v = m, _ = -1, F = -1, x = -1, z = m, Z = new co(512 + (m << 2)), C = new fo(Z, 0, 256), W = new Sr(Z, 0, 256), Q = new Sr(Z, 512, m), G = 512 + (m << 1), X = new V(Z, G, m), ur = new V(Z, G + m); _ < 255 && v > 0; ) {
    var T = Mr(v + 1), U = l >> 3, q = (1 << T + 1) - 1, Y = (c[U] | c[U + 1] << 8 | c[U + 2] << 16) >> (l & 7) & q, g = (1 << T) - 1, A = q - v - 1, y = Y & g;
    if (y < A ? (l += T, Y = y) : (l += T + 1, Y > g && (Y -= A)), C[++_] = --Y, Y == -1 ? (v += Y, X[--z] = _) : v -= Y, !Y) do {
      var b = l >> 3;
      F = (c[b] | c[b + 1] << 8) >> (l & 7) & 3, l += 2, _ += F;
    } while (F == 3);
  }
  (_ > 255 || v) && J(0);
  for (var rr = 0, nr = (m >> 1) + (m >> 3) + 3, ar = m - 1, er = 0; er <= _; ++er) {
    var N = C[er];
    if (N < 1) {
      W[er] = -N;
      continue;
  ...
  for (rr && J(0), x = 0; x < m; ++x) {
    var K = W[X[x]]++, tr = ur[x] = h - Mr(K);
    Q[x] = (K << tr) - m;
  }
  return [l + 7 >> 3, { b: h, s: X, n: ur, t: Q }];
};
var vo = function(c, f) {
  var s = 0, l = -1, h = new V(292), m = c[f], v = h.subarray(0, 256), _ = h.subarray(256, 268), F = new Sr(h.buffer, 268);
  if (m < 128) {
    var x = qr(c, f + 1, 6), z = x[0], Z = x[1];
    f += m;
    var C = z << 3, W = c[f];
    W || J(0);
    for (var Q = 0, G = 0, X = Z.b, ur = X, T = (++f << 3) - 8 + Mr(W); T -= X, !(T < C); ) {
      var U = T >> 3;
      if (Q += (c[U] | c[U + 1] << 8) >> (T & 7) & (1 << X) - 1, v[++l] = Z.s[Q], T -= ur, T < C) break;
      U = T >> 3, G += (c[U] | c[U + 1] << 8) >> (T & 7) & (1 << ur) - 1, v[++l] = Z.s[G], X = Z.n[Q], Q = Z.t[Q], ur = Z.n[G], G = Z.t[G];
    }
    ++l > 255 && J(0);
  } else {
    for (l = m - 127; s < l; s += 2) {
  ...
  var A = Mr(Y) + 1, y = 1 << A, b = y - Y;
  for (b & b - 1 && J(0), v[l++] = Mr(b) + 1, s = 0; s < l; ++s) {
    var g = v[s];
    ++_[v[s] = g && A + 1 - g];
  }
  var rr = new V(y << 1), nr = rr.subarray(0, y), ar = rr.subarray(y);
  for (F[A] = 0, s = A; s > 0; --s) {
    var er = F[s];
    Wr(ar, s, er, F[s - 1] = er + _[s] * (1 << A - s));
  }
  for (F[0] != y && J(0), s = 0; s < l; ++s) {
    var N = v[s];
    if (N) {
      var K = F[N];
      Wr(nr, s, K, F[N] = K + (1 << A - N));
    }
  }
  return [f, { n: ar, b: A, s: nr }];
};
var mo = qr(new V([81, 16, 99, 140, 49, 198, 24, 99, 12, 33, 196, 24, 99, 102, 102, 134, 70, 146, 4]), 0, 6)[1];
var yo = qr(new V([33, 20, 196, 24, 99, 140, 33, 132, 16, 66, 8, 33, 132, 16, 66, 8, 33, 68, 68, 68, 68, 68, 68, 68, 68, 36, 9]), 0, 6)[1];
var Bo = qr(new V([32, 132, 16, 66, 102, 70, 68, 68, 68, 68, 36, 73, 2]), 0, 5)[1];
var Wt = function(c, f) {
  for (var s = c.length, l = new $r(s), h = 0; h < s; ++h) l[h] = f, f += 1 << c[h];
  return l;
};
var dt = new V(new $r([0, 0, 0, 0, 16843009, 50528770, 134678020, 202050057, 269422093]).buffer, 0, 36);
var _o = Wt(dt, 0);
var ft = new V(new $r([0, 0, 0, 0, 0, 0, 0, 0, 16843009, 50528770, 117769220, 185207048, 252579084, 16]).buffer, 0, 53);
var Mo = Wt(ft, 3);
var Pr = function(c, f, s) {
  var l = c.length, h = f.length, m = c[l - 1], v = (1 << s.b) - 1, _ = -s.b;
  m || J(0);
  for (var F = 0, x = s.b, z = (l << 3) - 8 + Mr(m) - x, Z = -1; z > _ && Z < h; ) {
    var C = z >> 3, W = (c[C] | c[C + 1] << 8 | c[C + 2] << 16) >> (z & 7);
    F = (F << x | W) & v, f[++Z] = s.s[F], z -= x = s.n[F];
  }
  (z != _ || Z + 1 != h) && J(0);
};
var Eo = function(c, f, s) {
  var l = 6, h = f.length, m = h + 3 >> 2, v = m << 1, _ = m + v;
  Pr(c.subarray(l, l += c[0] | c[1] << 8), f.subarray(0, m), s), Pr(c.subarray(l, l += c[2] | c[3] << 8), f.subarray(m, v), s), Pr(c.subarray(l, l += c[4] | c[5] << 8), f.subarray(v, _), s), Pr(c.subarray(l), f.subarray(_), s);
};
var bo = function(c, f, s) {
  var l, h = f.b, m = c[h], v = m >> 1 & 3;
  f.l = m & 1;
  var _ = m >> 3 | c[h + 1] << 5 | c[h + 2] << 13, F = (h += 3) + _;
  if (v == 1) return h >= c.length ? void 0 : (f.b = h + 1, s ? (Wr(s, c[h], f.y, f.y += _), s) : Wr(new V(_), c[h]));
  if (!(F > c.length)) {
    if (v == 0) return f.b = F, s ? (s.set(c.subarray(h, F), f.y), f.y += _, s) : st(c, h, F);
    if (v == 2) {
      var x = c[h], z = x & 3, Z = x >> 2 & 3, C = x >> 4, W = 0, Q = 0;
      z < 2 ? Z & 1 ? C |= c[++h] << 4 | (Z & 2 && c[++h] << 12) : C = x >> 3 : (Q = Z, Z < 2 ? (C |= (c[++h] & 63) << 4, W = c[h] >> 6 | c[++h] << 2) : Z == 2 ? (C |= c[++h] << 4 | (c[++h] & 3) << 12, W = c[h] >> 2 | c[++h] << 6) : (C |= c[++h] << 4 | (c[++h] & 63) << 12, W = c[h] >> 6 | c[++h] << 2 | c[++h] << 10)), ++h;
      var G = s ? s.subarray(f.y, f.y + f.m) : new V(f.m), X = G.length - C;
      if (z == 0) G.set(c.subarray(h, h += C), X);
      else if (z == 1) Wr(G, c[h++], X);
      else {
        var ur = f.h;
        if (z == 2) {
          var T = vo(c, h);
          W += h - (h = T[0]), f.h = ur = T[1];
        } else ur || J(0);
        (Q ? Eo : Pr)(c.subarray(h, h += W), G.subarray(X), ur);
      }
      var U = c[h++];
      if (U) {
        U == 255 ? U = (c[h++] | c[h++] << 8) + 32512 : U > 127 && (U = U - 128 << 8 | c[h++]);
        var q = c[h++];
        q & 3 && J(0);
        for (var Y = [yo, Bo, mo], g = 2; g > -1; --g) {
          var A = q >> (g << 1) + 2 & 3;
          if (A == 1) {
            var y = new V([0, 0, c[h++]]);
            Y[g] = { s: y.subarray(2, 3), n: y.subarray(0, 1), t: new Sr(y.buffer, 0, 1), b: 0 };
          } else A == 2 ? (l = qr(c, h, 9 - (g & 1)), h = l[0], Y[g] = l[1]) : A == 3 && (f.t || J(0), Y[g] = f.t[g]);
        }
        var b = f.t = Y, rr = b[0], nr = b[1], ar = b[2], er = c[F - 1];
        er || J(0);
        var N = (F << 3) - 8 + Mr(er) - ar.b, K = N >> 3, tr = 0, S = (c[K] | c[K + 1] << 8) >> (N & 7) & (1 << ar.b) - 1;
        K = (N -= nr.b) >> 3;
        var vr = (c[K] | c[K + 1] << 8) >> (N & 7) & (1 << nr.b) - 1;
        K = (N -= rr.b) >> 3;
        var Er = (c[K] | c[K + 1] << 8) >> (N & 7) & (1 << rr.b) - 1;
        for (++U; --U; ) {
          var Or = ar.s[S], Yr = ar.n[S], Ir = rr.s[Er], Lr = rr.n[Er], zr = nr.s[vr], Ur = nr.n[vr];
          K = (N -= zr) >> 3;
          var w = 1 << zr, D = w + ((c[K] | c[K + 1] << 8 | c[K + 2] << 16 | c[K + 3] << 24) >>> (N & 7) & w - 1);
          K = (N -= ft[Ir]) >> 3;
          var Br = Mo[Ir] + ((c[K] | c[K + 1] << 8 | c[K + 2] << 16) >> (N & 7) & (1 << ft[Ir]) - 1);
          K = (N -= dt[Or]) >> 3;
          var br = _o[Or] + ((c[K] | c[K + 1] << 8 | c[K + 2] << 16) >> (N & 7) & (1 << dt[Or]) - 1);
          if (K = (N -= Yr) >> 3, S = ar.t[S] + ((c[K] | c[K + 1] << 8) >> (N & 7) & (1 << Yr) - 1), K = (N -= Lr) >> 3, Er = rr.t[Er] + ((c[K] | c[K + 1] << 8) >> (N & 7) & (1 << Lr) - 1), K = (N -= Ur) >> 3, vr = nr.t[vr] + ((c[K] | c[K + 1] << 8) >> (N & 7) & (1 << Ur) - 1), D > 3) f.o[2] = f.o[1], f.o[1] = f.o[0], f.o[0] = D -= 3;
          else {
            var Dr = D - (br != 0);
            Dr ? (D = Dr == 3 ? f.o[0] - 1 : f.o[Dr], Dr > 1 && (f.o[2] = f.o[1]), f.o[1] = f.o[0], f.o[0] = D) : D = f.o[0];
          }
          for (var g = 0; g < br; ++g) G[tr + g] = G[X + g];
          tr += br, X += br;
          var mr = tr - D;
          if (mr < 0) {
            var _r = -mr, Ar = f.e + mr;
            _r > Br && (_r = Br);
            for (var g = 0; g < _r; ++g) G[tr + g] = f.w[Ar + g];
            tr += _r, Br -= _r, mr = 0;
          }
          for (var g = 0; g < Br; ++g) G[tr + g] = G[mr + g];
          tr += Br;
        }
        if (tr != X) for (; X < G.length; ) G[tr++] = G[X++];
        else tr = G.length;
        s ? f.y += tr : G = st(G, 0, tr);
      } else if (s) {
        if (f.y += C, X) for (var g = 0; g < C; ++g) G[g] = G[X + g];
      } else X && (G = st(G, X));
      return f.b = F, G;
    }
    J(2);
...
var Do = function(c, f) {
  ...
  for (var s = new V(f), l = 0, h = 0; l < c.length; ++l) {
    var m = c[l];
    s.set(m, h), h += m.length;
  }
  return s;
};
function ko(c, f) {
  for (var s = [], l = +!f, h = 0, m = 0; c.length; ) {
    var v = wo(c, l || f);
    if (typeof v == "object") {
      for (l ? (f = null, v.w.length == v.u && (s.push(f = v.w), m += v.u)) : (s.push(f), v.e = 0); !v.l; ) {
        var _ = bo(c, v, f);
        _ || J(5), f ? v.e = v.y : (s.push(_), m += _.length, lo(v.w, 0, _.length), v.w.set(_, v.w.length - _.length));
      }
      h = v.b + v.c * 4;
    } else h = v;
    c = c.subarray(h);
...
async function go(c = {}) {
  var f, s = c, l = false, h = "./this.program", m = (r, t) => {
    throw t;
  }, v = "", _ = "";
  function F(r) {
    return _ + r;
  }
  var x, z, Z = console.log.bind(console), C = console.error.bind(console), W, Q = false, G;
  function X(r, t) {
    r || S(t);
  }
  var ur = (r) => r.startsWith("file://"), T, U, q, Y, g, A, y, b, rr, nr, ar = false;
  function er() {
    var r = Tr.buffer;
    q = new Int8Array(r), g = new Int16Array(r), Y = new Uint8Array(r), A = new Uint16Array(r), y = new Int32Array(r), b = new Uint32Array(r), rr = new Float32Array(r), nr = new Float64Array(r);
  }
  function N() {
  }
  function K() {
    ar = true, br(Xe), !s.noFSInit && !o.initialized && o.init(), yr.init(), xr.B(), o.ignorePermissions = false;
  }
  function tr() {
  }
  function S(r) {
    r = "Aborted(" + r + ")", C(r), Q = true, r += ". Build with -sASSERTIONS for more info.";
    var t = new WebAssembly.RuntimeError(r);
    throw U == null ? void 0 : U(t), t;
  }
  var vr;
  let Er = () => "";
  function Or(r) {
    if (r == vr && W) return new Uint8Array(W);
    if (z) return z(r);
  ...
  async function Ir(r, t) {
    try {
      var e = await Yr(r), n = await WebAssembly.instantiate(e, t);
      return n;
    } catch (a) {
      C(`failed to asynchronously prepare wasm: ${a}`), S(a);
    }
  }
  async function Lr(r, t, e) {
    if (!r && !ur(t)) try {
      var n = fetch(t, { credentials: "same-origin" }), a = await WebAssembly.instantiateStreaming(n, e);
      return a;
    } catch (i) {
      C(`wasm streaming compile failed: ${i}`), C("falling back to ArrayBuffer instantiation");
    }
    return Ir(t, e);
  }
  function zr() {
  ...
  async function Ur() {
    function r(i, u) {
      return xr = i.exports, eo(xr), er(), xr;
    }
    function t(i) {
      return r(i.instance);
    }
  ...
  var mr = 0, _r = 0, Ar = (r, t, e) => {
    var n = new Dr(r);
    throw n.init(t, e), mr = r, _r++, mr;
  }, R = { isAbs: (r) => r.charAt(0) === "/", splitPath: (r) => {
    var t = /^(\/?|)([\s\S]*?)((?:\.{1,2}|[^\/]+?|)(\.[^.\/]*|))(?:[\/]*)$/;
    return t.exec(r).slice(1);
  }, normalizeArray: (r, t) => {
    for (var e = 0, n = r.length - 1; n >= 0; n--) {
      var a = r[n];
      a === "." ? r.splice(n, 1) : a === ".." ? (r.splice(n, 1), e++) : e && (r.splice(n, 1), e--);
    }
    if (t) for (; e; e--) r.unshift("..");
    return r;
  }, normalize: (r) => {
    var t = R.isAbs(r), e = r.slice(-1) === "/";
    return r = R.normalizeArray(r.split("/").filter((n) => !!n), !t).join("/"), !r && !t && (r = "."), r && e && (r += "/"), (t ? "/" : "") + r;
  }, dirname: (r) => {
    var t = R.splitPath(r), e = t[0], n = t[1];
    return !e && !n ? "." : (n && (n = n.slice(0, -1)), e + n);
  }, basename: (r) => r && r.match(/([^\/]+|\/)\/*$/)[1], join: (...r) => R.normalize(r.join("/")), join2: (r, t) => R.normalize(r + "/" + t) }, Xt = () => (r) => crypto.getRandomValues(r), lt = (r) => {
    (lt = Xt())(r);
  }, kr = { resolve: (...r) => {
    for (var t = "", e = false, n = r.length - 1; n >= -1 && !e; n--) {
      var a = n >= 0 ? r[n] : o.cwd();
      if (typeof a != "string") throw new TypeError("Arguments to path.resolve must be strings");
      if (!a) return "";
      t = a + "/" + t, e = R.isAbs(a);
    }
    return t = R.normalizeArray(t.split("/").filter((i) => !!i), !e).join("/"), (e ? "/" : "") + t || ".";
  }, relative: (r, t) => {
    r = kr.resolve(r).slice(1), t = kr.resolve(t).slice(1);
    function e(M) {
      for (var j = 0; j < M.length && M[j] === ""; j++) ;
      for (var L = M.length - 1; L >= 0 && M[L] === ""; L--) ;
      return j > L ? [] : M.slice(j, L - j + 1);
    }
    for (var n = e(r.split("/")), a = e(t.split("/")), i = Math.min(n.length, a.length), u = i, d = 0; d < i; d++) if (n[d] !== a[d]) {
      u = d;
      break;
    }
    for (var p = [], d = u; d < n.length; d++) p.push("..");
    return p = p.concat(a.slice(u)), p.join("/");
  } }, ht = globalThis.TextDecoder && new TextDecoder(), qt = (r, t, e, n) => {
    var a = t + e;
    if (n) return a;
    for (; r[t] && !(t >= a); ) ++t;
    return t;
    ...
    var a = qt(r, t, e, n);
    if (a - t > 16 && r.buffer && ht) return ht.decode(r.subarray(t, a));
    for (var i = ""; t < a; ) {
      var u = r[t++];
      if (!(u & 128)) {
      ...
      var d = r[t++] & 63;
      if ((u & 224) == 192) {
        i += String.fromCharCode((u & 31) << 6 | d);
        continue;
      }
      var p = r[t++] & 63;
      if ((u & 240) == 224 ? u = (u & 15) << 12 | d << 6 | p : u = (u & 7) << 18 | d << 12 | p << 6 | r[t++] & 63, u < 65536) i += String.fromCharCode(u);
      else {
        var M = u - 65536;
    ...
    if (!(n > 0)) return 0;
    for (var a = e, i = e + n - 1, u = 0; u < r.length; ++u) {
      var d = r.codePointAt(u);
      if (d <= 127) {
        if (e >= i) break;
        t[e++] = d;
      } else if (d <= 2047) {
        if (e + 1 >= i) break;
        t[e++] = 192 | d >> 6, t[e++] = 128 | d & 63;
      } else if (d <= 65535) {
        if (e + 2 >= i) break;
        t[e++] = 224 | d >> 12, t[e++] = 128 | d >> 6 & 63, t[e++] = 128 | d & 63;
      } else {
        if (e + 3 >= i) break;
        t[e++] = 240 | d >> 18, t[e++] = 128 | d >> 12 & 63, t[e++] = 128 | d >> 6 & 63, t[e++] = 128 | d & 63, u++;
      }
    }
    return t[e] = 0, e - a;
  }, Vr = (r, t, e) => {
    var n = e > 0 ? e : tt(r) + 1, a = new Array(n), i = pt(r, a, 0, a.length);
    ...
    yr.ttys[r] = { input: [], output: [], ops: t }, o.registerDevice(r, yr.stream_ops);
  }, stream_ops: { open(r) {
    var t = yr.ttys[r.node.rdev];
    if (!t) throw new o.ErrnoError(43);
    r.tty = t, r.seekable = false;
  }, close(r) {
    ...
    for (var i = 0, u = 0; u < n; u++) {
      var d;
      try {
        d = r.tty.ops.get_char(r.tty);
      } catch {
        throw new o.ErrnoError(29);
      }
      if (d === void 0 && i === 0) throw new o.ErrnoError(6);
      if (d == null) break;
      i++, t[e + u] = d;
    }
    ...
    try {
      for (var i = 0; i < n; i++) r.tty.ops.put_char(r.tty, t[e + i]);
    } catch {
      throw new o.ErrnoError(29);
    }
    return n && (r.node.mtime = r.node.ctime = Date.now()), i;
  } }, default_tty_ops: { get_char(r) {
    return Yt();
  }, put_char(r, t) {
    t === null || t === 10 ? (Z(gr(r.output)), r.output = []) : t != 0 && r.output.push(t);
  }, fsync(r) {
    var _a;
    ((_a = r.output) == null ? void 0 : _a.length) > 0 && (Z(gr(r.output)), r.output = []);
  }, ioctl_tcgets(r) {
    ...
    return [24, 80];
  } }, default_tty1_ops: { put_char(r, t) {
    t === null || t === 10 ? (C(gr(r.output)), r.output = []) : t != 0 && r.output.push(t);
  }, fsync(r) {
    var _a;
    ((_a = r.output) == null ? void 0 : _a.length) > 0 && (C(gr(r.output)), r.output = []);
  } } }, Lt = (r, t) => Y.fill(0, r, r + t), et = (r, t) => Math.ceil(r / t) * t, wt = (r) => {
    r = et(r, 65536);
    var t = Nt(65536, r);
    return t && Lt(t, r), t;
  }, k = { ops_table: null, mount(r) {
    ...
    var t = {};
    return t.dev = o.isChrdev(r.mode) ? r.id : 1, t.ino = r.id, t.mode = r.mode, t.nlink = 1, t.uid = 0, t.gid = 0, t.rdev = r.rdev, o.isDir(r.mode) ? t.size = 4096 : o.isFile(r.mode) ? t.size = r.usedBytes : o.isLink(r.mode) ? t.size = r.link.length : t.size = 0, t.atime = new Date(r.atime), t.mtime = new Date(r.mtime), t.ctime = new Date(r.ctime), t.blksize = 4096, t.blocks = Math.ceil(t.size / t.blksize), t;
  }, setattr(r, t) {
    for (let e of ["mode", "atime", "mtime", "ctime"]) t[e] != null && (r[e] = t[e]);
    t.size !== void 0 && k.resizeFileStorage(r, t.size);
  }, lookup(r, t) {
    throw k.doesNotExistError || (k.doesNotExistError = new o.ErrnoError(44), k.doesNotExistError.stack = "<generic error, no stack>"), k.doesNotExistError;
  }, mknod(r, t, e, n) {
    ...
    if (n) {
      if (o.isDir(r.mode)) for (var a in n.contents) throw new o.ErrnoError(55);
      o.hashRemoveNode(n);
    }
    delete r.parent.contents[r.name], t.contents[e] = r, r.name = e, t.ctime = t.mtime = r.parent.ctime = r.parent.mtime = Date.now();
  }, unlink(r, t) {
    delete r.contents[t], r.ctime = r.mtime = Date.now();
  }, rmdir(r, t) {
    var e = o.lookupNode(r, t);
    ...
    return r.link;
  } }, stream_ops: { read(r, t, e, n, a) {
    var i = r.node.contents;
    if (a >= r.node.usedBytes) return 0;
    var u = Math.min(r.node.usedBytes - a, n);
    if (u > 8 && i.subarray) t.set(i.subarray(a, a + u), e);
    else for (var d = 0; d < u; d++) t[e + d] = i[a + d];
    return u;
  }, write(r, t, e, n, a, i) {
    if (t.buffer === q.buffer && (i = false), !n) return 0;
    var u = r.node;
    if (u.mtime = u.ctime = Date.now(), t.subarray && (!u.contents || u.contents.subarray)) {
      if (i) return u.contents = t.subarray(e, e + n), u.usedBytes = n, n;
      if (u.usedBytes === 0 && a === 0) return u.contents = t.slice(e, e + n), u.usedBytes = n, n;
      if (a + n <= u.usedBytes) return u.contents.set(t.subarray(e, e + n), a), n;
    }
    if (k.expandFileStorage(u, a + n), u.contents.subarray && t.subarray) u.contents.set(t.subarray(e, e + n), a);
    else for (var d = 0; d < n; d++) u.contents[a + d] = t[e + d];
    return u.usedBytes = Math.max(u.usedBytes, a + n), n;
  }, llseek(r, t, e) {
    var n = t;
    if (e === 1 ? n += r.position : e === 2 && o.isFile(r.node.mode) && (n += r.node.usedBytes), n < 0) throw new o.ErrnoError(28);
    return n;
  }, mmap(r, t, e, n, a) {
    if (!o.isFile(r.node.mode)) throw new o.ErrnoError(43);
    var i, u, d = r.node.contents;
    if (!(a & 2) && d && d.buffer === q.buffer) u = false, i = d.byteOffset;
    else {
      if (u = true, i = wt(t), !i) throw new o.ErrnoError(48);
      d && ((e > 0 || e + t < d.length) && (d.subarray ? d = d.subarray(e, e + t) : d = Array.prototype.slice.call(d, e, e + t)), q.set(d, i));
    }
    return { ptr: i, allocated: u };
  }, msync(r, t, e, n, a) {
    return k.stream_ops.write(r, t, 0, n, e, false), 0;
  } } }, zt = (r) => {
    var t = { r: 0, "r+": 2, w: 577, "w+": 578, a: 1089, "a+": 1090 }, e = t[r];
    if (typeof e > "u") throw new Error(`Unknown file open mode: ${r}`);
    return e;
  }, ot = (r, t) => {
    var e = 0;
    ...
    var t = await x(r);
    return new Uint8Array(t);
  }, Vt = (...r) => o.createDataFile(...r), Jt = (r) => r, Cr = 0, Zr = null, Tt = (r) => {
    if (Cr--, Cr == 0 && Zr) {
      var t = Zr;
      Zr = null, t();
    }
    ...
    for (var e of St) if (e.canHandle(t)) return e.handle(r, t);
    return r;
  }, vt = async (r, t, e, n, a, i, u, d) => {
    var p = t ? kr.resolve(R.join2(r, t)) : r, M = Jt(`cp ${p}`);
    Qt(M);
    try {
      var j = e;
      typeof e == "string" && (j = await Ut(e)), j = await $t(j, p), d == null ? void 0 : d(), i || Vt(r, t, j, n, a, u);
    } finally {
      Tt(M);
    }
  }, At = (r, t, e, n, a, i, u, d, p, M) => {
    vt(r, t, e, n, a, d, p, M).then(i).catch(u);
    ...
    constructor(r, t, e, n) {
      ...
      r || (r = this), this.parent = r, this.mount = r.mount, this.id = o.nextInode++, this.name = t, this.mode = e, this.rdev = n, this.atime = this.mtime = this.ctime = Date.now();
    }
    get read() {
    ...
    t.follow_mount ?? (t.follow_mount = true), R.isAbs(r) || (r = o.cwd() + "/" + r);
    r: for (var e = 0; e < 40; e++) {
      for (var n = r.split("/").filter((M) => !!M), a = o.root, i = "/", u = 0; u < n.length; u++) {
        var d = u === n.length - 1;
        if (d && t.parent) break;
        if (n[u] !== ".") {
          if (n[u] === "..") {
            if (i = R.dirname(i), o.isRoot(a)) {
              r = i + "/" + n.slice(u + 1).join("/"), e--;
              continue r;
            } else a = a.parent;
            continue;
          }
          ...
          try {
            ...
            if ((M == null ? void 0 : M.errno) === 44 && d && t.noent_okay) return { path: i };
            throw M;
          }
          if (o.isMountpoint(a) && (!d || t.follow_mount) && (a = a.mounted.root), o.isLink(a.mode) && (!d || t.follow)) {
            if (!a.node_ops.readlink) throw new o.ErrnoError(52);
            var p = a.node_ops.readlink(a);
            R.isAbs(p) || (p = R.dirname(i) + "/" + p), r = p + "/" + n.slice(u + 1).join("/");
            continue r;
          }
        }
      }
    ...
    return (r + e >>> 0) % o.nameTable.length;
  }, hashAddNode(r) {
    ...
    else for (var e = o.nameTable[t]; e; ) {
      if (e.name_next === r) {
    ...
    for (var n = o.hashName(r.id, t), a = o.nameTable[n]; a; a = a.name_next) {
      var i = a.name;
      if (a.parent.id === r.id && i === t) return a;
    }
    return o.lookup(r, t);
  }, createNode(r, t, e, n) {
    var a = new o.FSNode(r, t, e, n);
    ...
    return o.ignorePermissions ? 0 : t.includes("r") && !(r.mode & 292) || t.includes("w") && !(r.mode & 146) || t.includes("x") && !(r.mode & 73) ? 2 : 0;
  }, mayLookup(r) {
    ...
    return r ? o.isLink(r.mode) ? 32 : o.isDir(r.mode) && (o.flagsToPermissionString(t) !== "r" || t & 576) ? 31 : o.nodePermissions(r, o.flagsToPermissionString(t)) : 44;
  }, checkOpExists(r, t) {
    if (!r) throw new o.ErrnoError(t);
    return r;
    ...
    return t;
  }, getStream: (r) => o.streams[r], createStream(r, t = -1) {
    return r = Object.assign(new o.FSStream(), r), t == -1 && (t = o.nextfd()), r.fd = t, o.streams[t] = r, r;
  }, closeStream(r) {
    o.streams[r] = null;
  }, dupStream(r, t = -1) {
    var _a, _b;
    var e = o.createStream(r, t);
    return (_b = (_a = e.stream_ops) == null ? void 0 : _a.dup) == null ? void 0 : _b.call(_a, e), e;
  }, doSetAttr(r, t, e) {
    var n = r == null ? void 0 : r.stream_ops.setattr, a = n ? r : t;
    n ?? (n = t.node_ops.setattr), o.checkOpExists(n, 63), n(a, e);
  }, chrdev_stream_ops: { open(r) {
    var _a, _b;
    var t = o.getDevice(r.node.rdev);
    r.stream_ops = t.stream_ops, (_b = (_a = r.stream_ops).open) == null ? void 0 : _b.call(_a, r);
  }, llseek() {
    throw new o.ErrnoError(70);
  } }, major: (r) => r >> 8, minor: (r) => r & 255, makedev: (r, t) => r << 8 | t, registerDevice(r, t) {
    o.devices[r] = { stream_ops: t };
  }, getDevice: (r) => o.devices[r], getMounts(r) {
    for (var t = [], e = [r]; e.length; ) {
      var n = e.pop();
      t.push(n), e.push(...n.mounts);
    }
    return t;
  }, syncfs(r, t) {
    typeof r == "function" && (t = r, r = false), o.syncFSRequests++, o.syncFSRequests > 1 && C(`warning: ${o.syncFSRequests} FS.syncfs operations in flight at once, probably just doing extra work`);
    var e = o.getMounts(o.root.mount), n = 0;
    function a(u) {
      return o.syncFSRequests--, t(u);
    }
    function i(u) {
    ...
    e.forEach((u) => {
      if (!u.type.syncfs) return i(null);
      u.type.syncfs(u, r, i);
    });
  }, mount(r, t, e) {
    var n = e === "/", a = !e, i;
    ...
    var d = { type: r, opts: t, mountpoint: e, mounts: [] }, p = r.mount(d);
    return p.mount = d, d.root = p, n ? o.root = p : i && (i.mounted = d, i.mount && i.mount.mounts.push(d)), p;
  }, unmount(r) {
    var t = o.lookupPath(r, { follow_mount: false });
    if (!o.isMountpoint(t.node)) throw new o.ErrnoError(28);
    var e = t.node, n = e.mounted, a = o.getMounts(n);
    Object.keys(o.nameTable).forEach((u) => {
      for (var d = o.nameTable[u]; d; ) {
        var p = d.name_next;
        a.includes(d.mount) && o.destroyNode(d), d = p;
      }
    }), e.mounted = null;
    ...
    var n = o.lookupPath(r, { parent: true }), a = n.node, i = R.basename(r);
    ...
    return a.node_ops.mknod(a, i, t, e);
  }, statfs(r) {
    return o.statfsNode(o.lookupPath(r, { follow: true }).node);
  }, statfsStream(r) {
    return o.statfsNode(r.node);
  }, statfsNode(r) {
    var t = { bsize: 4096, frsize: 4096, blocks: 1e6, bfree: 5e5, bavail: 5e5, files: o.nextInode, ffree: o.nextInode - 1, fsid: 42, flags: 2, namelen: 255 };
    return r.node_ops.statfs && Object.assign(t, r.node_ops.statfs(r.mount.opts.root)), t;
  }, create(r, t = 438) {
    return t &= 4095, t |= 32768, o.mknod(r, t, 0);
  }, mkdir(r, t = 511) {
    return t &= 1023, t |= 16384, o.mknod(r, t, 0);
  }, mkdirTree(r, t) {
    var e = r.split("/"), n = "";
    for (var a of e) if (a) {
      (n || R.isAbs(r)) && (n += "/"), n += a;
    ...
    return typeof e > "u" && (e = t, t = 438), t |= 8192, o.mknod(r, t, e);
  }, symlink(r, t) {
    if (!kr.resolve(r)) throw new o.ErrnoError(44);
    var e = o.lookupPath(t, { parent: true }), n = e.node;
    if (!n) throw new o.ErrnoError(44);
    var a = R.basename(t), i = o.mayCreate(n, a);
    if (i) throw new o.ErrnoError(i);
    if (!n.node_ops.symlink) throw new o.ErrnoError(63);
    return n.node_ops.symlink(n, a, r);
  }, rename(r, t) {
    var e = R.dirname(r), n = R.dirname(t), a = R.basename(r), i = R.basename(t), u, d, p;
    if (u = o.lookupPath(r, { parent: true }), d = u.node, u = o.lookupPath(t, { parent: true }), p = u.node, !d || !p) throw new o.ErrnoError(44);
    if (d.mount !== p.mount) throw new o.ErrnoError(75);
    var M = o.lookupNode(d, a), j = kr.relative(r, n);
    if (j.charAt(0) !== ".") throw new o.ErrnoError(28);
    if (j = kr.relative(t, e), j.charAt(0) !== ".") throw new o.ErrnoError(55);
    var L;
    try {
      L = o.lookupNode(p, i);
    } catch {
    ...
    if (M !== L) {
      var O = o.isDir(M.mode), E = o.mayDelete(d, a, O);
      if (E) throw new o.ErrnoError(E);
      if (E = L ? o.mayDelete(p, i, O) : o.mayCreate(p, i), E) throw new o.ErrnoError(E);
      if (!d.node_ops.rename) throw new o.ErrnoError(63);
      if (o.isMountpoint(M) || L && o.isMountpoint(L)) throw new o.ErrnoError(10);
      if (p !== d && (E = o.nodePermissions(d, "w"), E)) throw new o.ErrnoError(E);
      o.hashRemoveNode(M);
      try {
        d.node_ops.rename(M, p, i), M.parent = p;
      } catch (H) {
        throw H;
      } finally {
        o.hashAddNode(M);
    ...
    var t = o.lookupPath(r, { parent: true }), e = t.node, n = R.basename(r), a = o.lookupNode(e, n), i = o.mayDelete(e, n, true);
    if (i) throw new o.ErrnoError(i);
    ...
    var t = o.lookupPath(r, { follow: true }), e = t.node, n = o.checkOpExists(e.node_ops.readdir, 54);
    return n(e);
  }, unlink(r) {
    var t = o.lookupPath(r, { parent: true }), e = t.node;
    if (!e) throw new o.ErrnoError(44);
    var n = R.basename(r), a = o.lookupNode(e, n), i = o.mayDelete(e, n, false);
    if (i) throw new o.ErrnoError(i);
    if (!e.node_ops.unlink) throw new o.ErrnoError(63);
    if (o.isMountpoint(a)) throw new o.ErrnoError(10);
    e.node_ops.unlink(e, n), o.destroyNode(a);
  }, readlink(r) {
    var t = o.lookupPath(r), e = t.node;
    if (!e) throw new o.ErrnoError(44);
    if (!e.node_ops.readlink) throw new o.ErrnoError(28);
    return e.node_ops.readlink(e);
  }, stat(r, t) {
    var e = o.lookupPath(r, { follow: !t }), n = e.node, a = o.checkOpExists(n.node_ops.getattr, 63);
    return a(n);
  }, fstat(r) {
    var t = o.getStreamChecked(r), e = t.node, n = t.stream_ops.getattr, a = n ? t : e;
    return n ?? (n = e.node_ops.getattr), o.checkOpExists(n, 63), n(a);
  }, lstat(r) {
    return o.stat(r, true);
  }, doChmod(r, t, e, n) {
    o.doSetAttr(r, t, { mode: e & 4095 | t.mode & -4096, ctime: Date.now(), dontFollow: n });
  }, chmod(r, t, e) {
    var n;
    if (typeof r == "string") {
      var a = o.lookupPath(r, { follow: !e });
      n = a.node;
    } else n = r;
    o.doChmod(null, n, t, e);
  }, lchmod(r, t) {
    o.chmod(r, t, true);
  }, fchmod(r, t) {
    var e = o.getStreamChecked(r);
    o.doChmod(e, e.node, t, false);
  }, doChown(r, t, e) {
    o.doSetAttr(r, t, { timestamp: Date.now(), dontFollow: e });
  }, chown(r, t, e, n) {
    var a;
    if (typeof r == "string") {
    ...
    o.doSetAttr(r, t, { size: e, timestamp: Date.now() });
  }, truncate(r, t) {
    if (t < 0) throw new o.ErrnoError(28);
    var e;
    if (typeof r == "string") {
      var n = o.lookupPath(r, { follow: true });
      e = n.node;
    } else e = r;
    o.doTruncate(null, e, t);
  }, ftruncate(r, t) {
    var e = o.getStreamChecked(r);
    if (t < 0 || (e.flags & 2097155) === 0) throw new o.ErrnoError(28);
    o.doTruncate(e, e.node, t);
  }, utime(r, t, e) {
    var n = o.lookupPath(r, { follow: true }), a = n.node, i = o.checkOpExists(a.node_ops.setattr, 63);
    i(a, { atime: t, mtime: e });
  }, open(r, t, e = 438) {
    if (r === "") throw new o.ErrnoError(44);
    t = typeof t == "string" ? zt(t) : t, t & 64 ? e = e & 4095 | 32768 : e = 0;
    var n, a;
    if (typeof r == "object") n = r;
    else {
      a = r.endsWith("/");
      var i = o.lookupPath(r, { follow: !(t & 131072), noent_okay: true });
      n = i.node, r = i.path;
    }
    var u = false;
    if (t & 64) if (n) {
      ...
      n = o.mknod(r, e | 511, 0), u = true;
    }
    if (!n) throw new o.ErrnoError(44);
    if (o.isChrdev(n.mode) && (t &= -513), t & 65536 && !o.isDir(n.mode)) throw new o.ErrnoError(54);
    if (!u) {
      var d = o.mayOpen(n, t);
      if (d) throw new o.ErrnoError(d);
    }
    t & 512 && !u && o.truncate(n, 0), t &= -131713;
    var p = o.createStream({ node: n, path: o.getPath(n), flags: t, seekable: true, position: 0, stream_ops: n.stream_ops, ungotten: [], error: false });
    return p.stream_ops.open && p.stream_ops.open(p), u && o.chmod(n, e & 511), p;
  }, close(r) {
    ...
    return r.position = r.stream_ops.llseek(r, t, e), r.ungotten = [], r.position;
  }, read(r, t, e, n, a) {
    ...
    var u = r.stream_ops.read(r, t, e, n, a);
    ...
    var d = r.stream_ops.write(r, t, e, n, a, i);
    return u || (r.position += d), d;
  }, mmap(r, t, e, n, a) {
    if ((n & 2) !== 0 && (a & 2) === 0 && (r.flags & 2097155) !== 2) throw new o.ErrnoError(2);
    if ((r.flags & 2097155) === 1) throw new o.ErrnoError(2);
    if (!r.stream_ops.mmap) throw new o.ErrnoError(43);
    if (!t) throw new o.ErrnoError(28);
    return r.stream_ops.mmap(r, t, e, n, a);
  }, msync(r, t, e, n, a) {
    return r.stream_ops.msync ? r.stream_ops.msync(r, t, e, n, a) : 0;
  }, ioctl(r, t, e) {
    if (!r.stream_ops.ioctl) throw new o.ErrnoError(59);
    return r.stream_ops.ioctl(r, t, e);
  }, readFile(r, t = {}) {
    t.flags = t.flags || 0, t.encoding = t.encoding || "binary", t.encoding !== "utf8" && t.encoding !== "binary" && S(`Invalid encoding type "${t.encoding}"`);
    var e = o.open(r, t.flags), n = o.stat(r), a = n.size, i = new Uint8Array(a);
    return o.read(e, i, 0, a, 0), t.encoding === "utf8" && (i = gr(i)), o.close(e), i;
  }, writeFile(r, t, e = {}) {
    e.flags = e.flags || 577;
    var n = o.open(r, e.flags, e.mode);
    typeof t == "string" && (t = new Uint8Array(Vr(t, true))), ArrayBuffer.isView(t) ? o.write(n, t, 0, t.byteLength, void 0, e.canOwn) : S("Unsupported data type"), o.close(n);
  }, cwd: () => o.currentPath, chdir(r) {
    var t = o.lookupPath(r, { follow: true });
    if (t.node === null) throw new o.ErrnoError(44);
    if (!o.isDir(t.node.mode)) throw new o.ErrnoError(54);
    var e = o.nodePermissions(t.node, "x");
    if (e) throw new o.ErrnoError(e);
    o.currentPath = t.path;
  }, createDefaultDirectories() {
    o.mkdir("/tmp"), o.mkdir("/home"), o.mkdir("/home/web_user");
  }, createDefaultDevices() {
    o.mkdir("/dev"), o.registerDevice(o.makedev(1, 3), { read: () => 0, write: (n, a, i, u, d) => u, llseek: () => 0 }), o.mkdev("/dev/null", o.makedev(1, 3)), yr.register(o.makedev(5, 0), yr.default_tty_ops), yr.register(o.makedev(6, 0), yr.default_tty1_ops), o.mkdev("/dev/tty", o.makedev(5, 0)), o.mkdev("/dev/tty1", o.makedev(6, 0));
    var r = new Uint8Array(1024), t = 0, e = () => (t === 0 && (lt(r), t = r.byteLength), r[--t]);
    ...
    o.mkdir("/proc/self/fd"), o.mount({ mount() {
      ...
      return t.stream_ops = { llseek: k.stream_ops.llseek }, t.node_ops = { lookup(e, n) {
  ...
  }, createStandardStreams(r, t, e) {
    r ? o.createDevice("/dev", "stdin", r) : o.symlink("/dev/tty", "/dev/stdin"), t ? o.createDevice("/dev", "stdout", null, t) : o.symlink("/dev/tty", "/dev/stdout"), e ? o.createDevice("/dev", "stderr", null, e) : o.symlink("/dev/tty1", "/dev/stderr");
    var n = o.open("/dev/stdin", 0), a = o.open("/dev/stdout", 1), i = o.open("/dev/stderr", 1);
  }, staticInit() {
    o.nameTable = new Array(4096), o.mount(k, {}, "/"), o.createDefaultDirectories(), o.createDefaultDevices(), o.createSpecialDirectories(), o.filesystems = { MEMFS: k };
  }, init(r, t, e) {
    o.initialized = true, o.createStandardStreams(r, t, e);
  }, quit() {
    o.initialized = false;
    for (var r of o.streams) r && o.close(r);
  }, findObject(r, t) {
    var e = o.analyzePath(r, t);
    return e.exists ? e.object : null;
  }, analyzePath(r, t) {
    try {
      var e = o.lookupPath(r, { follow: !t });
      r = e.path;
    } catch {
    }
    ...
    try {
      var e = o.lookupPath(r, { parent: true });
      n.parentExists = true, n.parentPath = e.path, n.parentObject = e.node, n.name = R.basename(r), e = o.lookupPath(r, { follow: !t }), n.exists = true, n.path = e.path, n.object = e.node, n.name = e.node.name, n.isRoot = e.path === "/";
    } catch (a) {
      n.error = a.errno;
    }
    return n;
    ...
    return u;
  }, createFile(r, t, e, n, a) {
    var i = R.join2(typeof r == "string" ? r : o.getPath(r), t), u = ot(n, a);
    return o.create(i, u);
  }, createDataFile(r, t, e, n, a, i) {
    var u = t;
    r && (r = typeof r == "string" ? r : o.getPath(r), u = t ? R.join2(r, t) : r);
    var d = ot(n, a), p = o.create(u, d);
    if (e) {
      if (typeof e == "string") {
        for (var M = new Array(e.length), j = 0, L = e.length; j < L; ++j) M[j] = e.charCodeAt(j);
        e = M;
      }
      o.chmod(p, d | 146);
      var O = o.open(p, 577);
      o.write(O, e, 0, e.length, 0, i), o.close(O), o.chmod(p, d);
    }
  }, createDevice(r, t, e, n) {
    var _a;
    var a = R.join2(typeof r == "string" ? r : o.getPath(r), t), i = ot(!!e, !!n);
    (_a = o.createDevice).major ?? (_a.major = 64);
    var u = o.makedev(o.createDevice.major++, 0);
    return o.registerDevice(u, { open(d) {
      d.seekable = false;
    }, close(d) {
      var _a2;
      ((_a2 = n == null ? void 0 : n.buffer) == null ? void 0 : _a2.length) && n(10);
    }, read(d, p, M, j, L) {
      for (var O = 0, E = 0; E < j; E++) {
        var H;
        try {
          H = e();
        } catch {
        ...
        if (H === void 0 && O === 0) throw new o.ErrnoError(6);
        if (H == null) break;
        O++, p[M + E] = H;
      }
      return O && (d.node.atime = Date.now()), O;
    }, write(d, p, M, j, L) {
      for (var O = 0; O < j; O++) try {
        n(p[M + O]);
      } catch {
        throw new o.ErrnoError(29);
      }
      return j && (d.node.mtime = d.node.ctime = Date.now()), O;
    } }), o.mkdev(a, i, u);
  }, forceLoadFile(r) {
    ...
    class i {
      ...
      get(E) {
        if (!(E > this.length - 1 || E < 0)) {
          var H = E % this.chunkSize, or = E / this.chunkSize | 0;
          return this.getter(or)[H];
        }
      }
      setDataGetter(E) {
        this.getter = E;
      ...
      cacheLength() {
        ...
        E.open("HEAD", e, false), E.send(null), E.status >= 200 && E.status < 300 || E.status === 304 || S("Couldn't load " + e + ". Status: " + E.status);
        var H = Number(E.getResponseHeader("Content-length")), or, fr = (or = E.getResponseHeader("Accept-Ranges")) && or === "bytes", ir = (or = E.getResponseHeader("Content-Encoding")) && or === "gzip", lr = 1024 * 1024;
        fr || (lr = H);
        var hr = (pr, Kr) => {
          pr > Kr && S("invalid range (" + pr + ", " + Kr + ") or no bytes requested!"), Kr > H - 1 && S("only " + H + " bytes available! programmer error!");
          var $ = new XMLHttpRequest();
          return $.open("GET", e, false), H !== lr && $.setRequestHeader("Range", "bytes=" + pr + "-" + Kr), $.responseType = "arraybuffer", $.overrideMimeType && $.overrideMimeType("text/plain; charset=x-user-defined"), $.send(null), $.status >= 200 && $.status < 300 || $.status === 304 || S("Couldn't load " + e + ". Status: " + $.status), $.response !== void 0 ? new Uint8Array($.response || []) : Vr($.responseText || "", true);
        }, Nr = this;
        Nr.setDataGetter((pr) => {
          var Kr = pr * lr, $ = (pr + 1) * lr - 1;
          return $ = Math.min($, H - 1), typeof Nr.chunks[pr] > "u" && (Nr.chunks[pr] = hr(Kr, $)), typeof Nr.chunks[pr] > "u" && S("doXHR failed!"), Nr.chunks[pr];
        }), (ir || !H) && (lr = H = 1, H = this.getter(0).length, lr = H, Z("LazyFiles on gzip forces download of the whole file when length is accessed")), this._length = H, this._chunkSize = lr, this.lengthKnown = true;
      }
      get length() {
    ...
    if (globalThis.XMLHttpRequest) {
      l || S("Cannot do synchronous binary XHRs outside webworkers in modern browsers. Use --embed-file or --preload-file in emcc");
      var u = new i(), d = { isDevice: false, contents: u };
    } else var d = { isDevice: false, url: e };
    var p = o.createFile(r, t, d, n, a);
    d.contents ? p.contents = d.contents : d.url && (p.contents = null, p.url = d.url), Object.defineProperties(p, { usedBytes: { get: function() {
      return this.contents.length;
    } } });
    var M = {}, j = Object.keys(p.stream_ops);
    j.forEach((O) => {
      var E = p.stream_ops[O];
      M[O] = (...H) => (o.forceLoadFile(p), E(...H));
    });
    function L(O, E, H, or, fr) {
      var ir = O.node.contents;
      if (fr >= ir.length) return 0;
      var lr = Math.min(ir.length - fr, or);
      if (ir.slice) for (var hr = 0; hr < lr; hr++) E[H + hr] = ir[fr + hr];
      else for (var hr = 0; hr < lr; hr++) E[H + hr] = ir.get(fr + hr);
      return lr;
    }
    return M.read = (O, E, H, or, fr) => (o.forceLoadFile(p), L(O, E, H, or, fr)), M.mmap = (O, E, H, or, fr) => {
      o.forceLoadFile(p);
      var ir = wt(E);
      if (!ir) throw new o.ErrnoError(48);
      return L(O, q, ir, E, H), { ptr: ir, allocated: true };
    }, p.stream_ops = M, p;
  } }, sr = (r, t, e) => r ? gr(Y, r, t, e) : "", P = { DEFAULT_POLLMASK: 5, calculateAt(r, t, e) {
    if (R.isAbs(t)) return t;
    var n;
    if (r === -100) n = o.cwd();
    else {
      var a = P.getStreamFromFD(r);
      n = a.path;
    }
    if (t.length == 0) {
      if (!e) throw new o.ErrnoError(44);
  ...
  function re(r, t, e, n) {
    try {
      if (t = P.getStr(t), t = P.calculateAt(r, t), e & -8) return -28;
      var a = o.lookupPath(t, { follow: true }), i = a.node;
      if (!i) return -44;
      var u = "";
  ...
  function ee(r, t) {
    try {
      return P.writeStat(t, o.fstat(r));
    } catch (e) {
      ...
      switch (t) {
        ...
        case 21508: {
          ...
          if (n.tty.ops.ioctl_tcsets) {
            for (var i = Fr(), d = y[i >> 2], p = y[i + 4 >> 2], M = y[i + 8 >> 2], j = y[i + 12 >> 2], L = [], u = 0; u < 32; u++) L.push(q[i + u + 17]);
            return n.tty.ops.ioctl_tcsets(n.tty, t, { c_iflag: d, c_oflag: p, c_cflag: M, c_lflag: j, c_cc: L });
          }
          return 0;
        }
        case 21519: {
        ...
        case 21531: {
          var i = Fr();
          return o.ioctl(n, t, i);
        }
        case 21523: {
          if (!n.tty) return -59;
          if (n.tty.ops.ioctl_tiocgwinsz) {
            var O = n.tty.ops.ioctl_tiocgwinsz(n.tty), i = Fr();
            g[i >> 1] = O[0], g[i + 2 >> 1] = O[1];
          }
          return 0;
        }
        case 21524:
  ...
  function ne(r, t, e, n) {
    try {
      ...
      return n = n & -6401, t = P.calculateAt(r, t, i), P.writeStat(e, a ? o.lstat(t) : o.stat(t));
    } catch (u) {
  ...
  function ae(r, t, e, n) {
    P.varargs = n;
    try {
      t = P.getStr(t), t = P.calculateAt(r, t);
      var a = n ? Jr() : 0;
      return o.open(t, e, a).fd;
    } catch (i) {
      if (typeof o > "u" || i.name !== "ErrnoError") throw i;
      return -i.errno;
    }
  }
  var Gr = (r, t, e) => pt(r, Y, t, e);
  function ie(r, t, e, n) {
    try {
      if (t = P.getStr(t), t = P.calculateAt(r, t), n <= 0) return -28;
      var a = o.readlink(t), i = Math.min(n, tt(a)), u = q[e + i];
      return Gr(a, e, n + 1), q[e + i] = u, i;
    } catch (d) {
      if (typeof o > "u" || d.name !== "ErrnoError") throw d;
      return -d.errno;
    }
  ...
  function ue(r) {
    try {
      return r = P.getStr(r), o.rmdir(r), 0;
    } catch (t) {
  ...
  function se(r, t, e) {
    try {
      if (t = P.getStr(t), t = P.calculateAt(r, t), !e) o.unlink(t);
      else if (e === 512) o.rmdir(t);
      else return -28;
      return 0;
    } catch (n) {
  ...
  var ce = () => S(""), de = (r) => r % 4 === 0 && (r % 100 !== 0 || r % 400 === 0), fe = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335], le = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334], he = (r) => {
    var t = de(r.getFullYear()), e = t ? fe : le, n = e[r.getMonth()] + r.getDate() - 1;
    return n;
  }, Rr = (r, t) => t + 2097152 >>> 0 < 4194305 - !!r ? (r >>> 0) + t * 4294967296 : NaN;
  function pe(r, t, e) {
    var n = Rr(r, t), a = new Date(n * 1e3);
    y[e >> 2] = a.getSeconds(), y[e + 4 >> 2] = a.getMinutes(), y[e + 8 >> 2] = a.getHours(), y[e + 12 >> 2] = a.getDate(), y[e + 16 >> 2] = a.getMonth(), y[e + 20 >> 2] = a.getFullYear() - 1900, y[e + 24 >> 2] = a.getDay();
    var i = he(a) | 0;
    y[e + 28 >> 2] = i, y[e + 36 >> 2] = -(a.getTimezoneOffset() * 60);
    var u = new Date(a.getFullYear(), 0, 1), d = new Date(a.getFullYear(), 6, 1).getTimezoneOffset(), p = u.getTimezoneOffset(), M = (d != p && a.getTimezoneOffset() == Math.min(p, d)) | 0;
    y[e + 32 >> 2] = M;
  }
  function we(r, t, e, n, a, i, u, d) {
    var p = Rr(a, i);
    try {
      var M = P.getStreamFromFD(n), j = o.mmap(M, r, p, t, e), L = j.ptr;
      return y[u >> 2] = j.allocated, b[d >> 2] = L, 0;
    } catch (O) {
      if (typeof o > "u" || O.name !== "ErrnoError") throw O;
      return -O.errno;
    }
  }
  function ve(r, t, e, n, a, i, u) {
    var d = Rr(i, u);
    try {
      var p = P.getStreamFromFD(a);
      e & 2 && P.doMsync(r, p, t, n, d);
    } catch (M) {
  ...
  var me = (r, t, e, n) => {
    var a = (/* @__PURE__ */ new Date()).getFullYear(), i = new Date(a, 0, 1), u = new Date(a, 6, 1), d = i.getTimezoneOffset(), p = u.getTimezoneOffset(), M = Math.max(d, p);
    b[r >> 2] = M * 60, y[t >> 2] = +(d != p);
    var j = (E) => {
      var H = E >= 0 ? "-" : "+", or = Math.abs(E), fr = String(Math.floor(or / 60)).padStart(2, "0"), ir = String(or % 60).padStart(2, "0");
      return `UTC${H}${fr}${ir}`;
    }, L = j(d), O = j(p);
    p < d ? (Gr(L, e, 17), Gr(O, n, 17)) : (Gr(L, n, 17), Gr(O, e, 17));
  }, ye = () => performance.now(), mt = () => Date.now(), Be = 1, _e = (r) => r >= 0 && r <= 3;
  function Me(r, t, e, n) {
    var a = Rr(t, e);
    if (!_e(r)) return 28;
    var i;
    ...
    return D = [u >>> 0, (w = u, +Math.abs(w) >= 1 ? w > 0 ? +Math.floor(w / 4294967296) >>> 0 : ~~+Math.ceil((w - +(~~w >>> 0)) / 4294967296) >>> 0 : 0)], y[n >> 2] = D[0], y[n + 4 >> 2] = D[1], 0;
  }
  var nt = [], Ee = (r, t) => {
    nt.length = 0;
    for (var e; e = Y[r++]; ) {
      var n = e != 105;
      n &= e != 112, t += n && t % 8 ? 4 : 0, nt.push(e == 112 ? b[t >> 2] : e == 105 ? y[t >> 2] : nr[t >> 3]), t += n ? 8 : 4;
    }
    return nt;
  }, be = (r, t, e) => {
    var n = Ee(t, e);
    return qe[r](...n);
  }, De = (r, t, e) => be(r, t, e), ke = () => 2147483648, ge = (r) => {
    var t = Tr.buffer.byteLength, e = (r - t + 65535) / 65536 | 0;
    try {
      return Tr.grow(e), er(), 1;
    } catch {
    }
  }, Fe = (r) => {
    var t = Y.length;
    ...
    for (var n = 1; n <= 4; n *= 2) {
      ...
      var i = Math.min(e, et(Math.max(r, a), 65536)), u = ge(i);
      if (u) return true;
    }
    return false;
  }, at = {}, Ge = () => h || "./this.program", Hr = () => {
    if (!Hr.strings) {
      var r = (typeof navigator == "object" && navigator.language || "C").replace("-", "_") + ".UTF-8", t = { USER: "web_user", LOGNAME: "web_user", PATH: "/", PWD: "/", HOME: "/home/web_user", LANG: r, _: Ge() };
      for (var e in at) at[e] === void 0 ? delete t[e] : t[e] = at[e];
      var n = [];
    ...
    b[r >> 2] = e.length;
    var n = 0;
    for (var a of e) n += tt(a) + 1;
    return b[t >> 2] = n, 0;
  }, Oe = () => true, Ie = (r) => {
    G = r, Oe() || (Q = true), m(r, new Br(r));
  }, Ce = (r, t) => {
    G = r, Ie(r);
  }, Ze = Ce;
  function Re(r) {
    try {
      var t = P.getStreamFromFD(r);
      return o.close(t), 0;
    } catch (e) {
      if (typeof o > "u" || e.name !== "ErrnoError") throw e;
      return e.errno;
  ...
  var He = (r, t, e, n) => {
    for (var a = 0, i = 0; i < e; i++) {
      var u = b[t >> 2], d = b[t + 4 >> 2];
      t += 8;
      var p = o.read(r, q, u, d, n);
      if (p < 0) return -1;
      if (a += p, p < d) break;
      typeof n < "u" && (n += p);
    }
  ...
  function xe(r, t, e, n) {
    try {
      var a = P.getStreamFromFD(r), i = He(a, t, e);
      return b[n >> 2] = i, 0;
    } catch (u) {
      if (typeof o > "u" || u.name !== "ErrnoError") throw u;
      return u.errno;
  ...
  function Ne(r, t, e, n, a) {
    var i = Rr(t, e);
    try {
      if (isNaN(i)) return 61;
      var u = P.getStreamFromFD(r);
      return o.llseek(u, i, n), D = [u.position >>> 0, (w = u.position, +Math.abs(w) >= 1 ? w > 0 ? +Math.floor(w / 4294967296) >>> 0 : ~~+Math.ceil((w - +(~~w >>> 0)) / 4294967296) >>> 0 : 0)], y[a >> 2] = D[0], y[a + 4 >> 2] = D[1], u.getdents && i === 0 && n === 0 && (u.getdents = null), 0;
    } catch (d) {
      if (typeof o > "u" || d.name !== "ErrnoError") throw d;
      return d.errno;
    }
  ...
  function We(r, t, e, n) {
    try {
      var a = P.getStreamFromFD(r), i = Pe(a, t, e);
      return b[n >> 2] = i, 0;
    } catch (u) {
      if (typeof o > "u" || u.name !== "ErrnoError") throw u;
      return u.errno;
  ...
  function it() {
    ...
    function r() {
      s.calledRun = true, !Q && (K(), T == null ? void 0 : T(s));
    }
    r();
  }
  var xr;
  ...
  function ut(r, t) {
    var e = Qr(t), n = e[r];
    return n || (n = Object.create((t || cr).prototype), n.ptr = r, e[r] = n);
  }
  s.wrapPointer = ut;
  function no(r, t) {
    return ut(r.ptr, t);
  }
  s.castObject = no, s.NULL = ut(0);
  function ao(r) {
    if (!r.__destroy__) throw "Error: Cannot destroy object. (Did you create it yourself?)";
    r.__destroy__(), delete Qr(r.__class__)[r.ptr];
  }
  s.destroy = ao;
  function io(r, t) {
    return r.ptr === t.ptr;
  ...
  s.getClass = so;
  var I = { buffer: 0, size: 0, pos: 0, temps: [], needed: 0, prepare() {
    if (I.needed) {
      for (var r = 0; r < I.temps.length; r++) s._webidl_free(I.temps[r]);
      I.temps.length = 0, s._webidl_free(I.buffer), I.buffer = 0, I.size += I.needed, I.needed = 0;
    }
    I.buffer || (I.size += 128, I.buffer = s._webidl_malloc(I.size), X(I.buffer)), I.pos = 0;
  }, alloc(r, t) {
    X(I.buffer);
    var e = t.BYTES_PER_ELEMENT, n = r.length * e;
    n = et(n, 8);
    var a;
    return I.pos + n >= I.size ? (X(n > 0), I.needed += n, a = s._webidl_malloc(n), I.temps.push(a)) : (a = I.buffer + I.pos, I.pos += n), a;
  } };
  function dr(r) {
    if (typeof r == "string") {
      for (var t = Vr(r), e = I.alloc(t, q), n = 0; n < t.length; n++) q[e + n] = t[n];
      return e;
    }
    return r;
  }
...
function Ro(c, f) {
  let s = { images: [], files: [], ...f };
  [...s.files, ...Zo(s.images)].forEach((l) => c.createFile(l.path, l.data));
}
var Ho = class jr {
  constructor(f) {
    this._module = f;
  ...
  layout(f, s = "svg", l = "dot", h) {
    if (!f) return "";
    let m = new this._module.Graphviz((h == null ? void 0 : h.yInvert) ? 1 : 0, (h == null ? void 0 : h.nop) ? h == null ? void 0 : h.nop : 0), v = "", _ = "";
    try {
      Ro(m, h);
      try {
        v = m.layout(f, s, l);
      ...
      this._module.destroy(m);
    }
    if (!v && _) throw jr.unload(), new Error(_);
    return v;
  }
  acyclic(f, s = false, l = false) {
    if (!f) return { acyclic: false, num_rev: 0, outFile: "" };
    let h = new this._module.Graphviz(), m = false, v = 0, _ = "", F = "";
    try {
      try {
        m = h.acyclic(f, s, l), v = h.acyclic_num_rev, _ = h.acyclic_outFile;
      } catch (x) {
        F = x.message;
      }
      F = h.lastError() || F;
    ...
    if (F) throw jr.unload(), new Error(F);
    return { acyclic: m, num_rev: v, outFile: _ };
  }
  tred(f, s = false, l = false) {
    if (!f) return { out: "", err: "" };
    let h = new this._module.Graphviz(), m = "", v = "", _ = "";
    try {
      try {
        h.tred(f, s, l), m = h.tred_out, v = h.tred_err;
      } catch (F) {
        _ = F.message;
      }
      _ = h.lastError() || _;
    ...
    if (!m && _) throw jr.unload(), new Error(_);
    return { out: m, err: v };
  }
  unflatten(f, s = 0, l = false, h = 0) {
    if (!f) return "";
    let m = new this._module.Graphviz(), v = "", _ = "";
    try {
      try {
        v = m.unflatten(f, s, l, h);
      } catch (F) {
        _ = F.message;
      }
      _ = m.lastError() || _;
  ...
  circo(f, s = "svg", l) {
    return this.layout(f, s, "circo", l);
  }
  dot(f, s = "svg", l) {
    return this.layout(f, s, "dot", l);
  }
  fdp(f, s = "svg", l) {
    return this.layout(f, s, "fdp", l);
  }
  sfdp(f, s = "svg", l) {
    return this.layout(f, s, "sfdp", l);
  }
  neato(f, s = "svg", l) {
    return this.layout(f, s, "neato", l);
  }
  osage(f, s = "svg", l) {
    return this.layout(f, s, "osage", l);
  }
  patchwork(f, s = "svg", l) {
    return this.layout(f, s, "patchwork", l);
  }
  twopi(f, s = "svg", l) {
    return this.layout(f, s, "twopi", l);
  }
  nop(f) {
...
function layoutDone(svgDoc, callback) {
    ...
    if (growEnteringEdges && !prevDatum && datum.parent) {
      if (isEdgeElement(datum)) {
        if (tag == "path" || tag == "polygon") {
          if (tag == "polygon") {
            var path2 = datum.parent.children.find(function(e) {
              return e.tag == "path";
            });
            if (path2) {
              datum.totalLength = path2.totalLength;
            }
          }
  ...
  var newDoc = select_default(document.createDocumentFragment()).append("div");
...
function on_default(typenames, callback) {
...
function drawEdge(x1, y1, x2, y2, attributes, options = {}) {
  ...
  if (attributes.style && attributes.style.includes("invis")) {
    var newEdge = select_default(null);
  } else {
    var root = this._selection;
    var svg = root.selectWithoutDataPropagation("svg");
...
function createEdge(attributes) {
  ...
  var parser = new window.DOMParser();
  var doc = parser.parseFromString(svgDoc, "image/svg+xml");
  var newDoc = select_default(document.createDocumentFragment()).append(function() {
    return doc.documentElement;
  });
...
function drawNode(x, y, nodeId, attributes = {}, options = {}) {
  attributes = Object.assign({}, attributes);
  if (attributes.style && attributes.style.includes("invis")) {
    var newNode = select_default(null);
  } else {
    var root = this._selection;
    var svg = root.selectWithoutDataPropagation("svg");
    var graph0 = svg.selectWithoutDataPropagation("g");
...
function _moveNode(node, x, y, attributes, options) {
  ...
  svgElements.each(function(data, index) {
    var svgElement = select_default(this);
...
function Graphviz(selection, options) {
  ...
  if (useWorker || useSharedWorker) {
    var scripts = selectAll_default("script");
    var vizScript = scripts.filter(function() {
      return select_default(this).attr("type") == "javascript/worker" || select_default(this).attr("src") && select_default(this).attr("src").match(/.*\/@hpcc-js\/wasm/);
    });
    if (vizScript.size() == 0) {
...
function graphviz(selector, options) {
  var g = select_default(selector).graphviz(options);
  return g;
}
...
function selectWithoutDataPropagation_default(name) {
  return select_default(this.size() > 0 ? this.node().querySelector(name) : null);
}
